...
if [[ "$FRAMEWORK" == 'angular' ]]; then
    ...
    if [ "$BUILD_TOOL" == 'angular-app' ]; then
        ...
        echo "cp templates/components/angular/template-tsconfig-${BUILD_TOOL_VERSION}.json mega-apps/${MEGA_APP_NAME}/tsconfig.json"
        cp templates/components/angular/template-tsconfig-${BUILD_TOOL_VERSION}.json mega-apps/${MEGA_APP_NAME}/tsconfig.json
