...
<SelectField placeholder="Please select a fruit">
...
To override styling on all SelectFields, you can set the Amplify CSS variables or use the built-in `.amplify-select` class.
