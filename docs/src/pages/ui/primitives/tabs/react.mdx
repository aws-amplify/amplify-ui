...
<Example>
  <Tabs backgroundColor="var(--amplify-colors-background-secondary)">
    <TabItem
      title="Tab 1"
...
Note: there is currently no way to style different states like hover using only style props. However Amplify UI works well with CSS in JS frameworks for this usecase. Take a look at the [alternative styling docs](/ui/theme/alternativeStyling) for information how to sue CSS in JS with Amplify UI.
