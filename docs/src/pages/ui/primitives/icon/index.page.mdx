...
Use an icon from the [Material Design icons](http://google.github.io/material-design-icons/).
...
Use the `size` prop to change the icon size. Available options are `large`, `medium`, and `small`.
