...
const MyApp = () => <SwitchField label={'This is a switch'} />;
```
...
<SwitchExample labelPosition={'start'} />
<SwitchExample labelPosition={'end'} />
<SwitchExample labelPosition={'top'} />
<SwitchExample labelPosition={'bottom'} />
