...
These [translations](https://github.com/aws-amplify/amplify-ui/blob/main/packages/ui/src/types/i18n.ts) can be customized using the [Amplify JS' `I18n`](https://docs.amplify.aws/lib/utilities/i18n/q/platform/js/) module:
...
<Alert variation="info" heading="Translations Needed 📖">
  ...
  [here](https://github.com/aws-amplify/amplify-ui/blob/main/packages/ui/src/types/i18n.ts).
</Alert>
