...
These are Amplify props that are added to certain Amplify components to change the look and/or behavior of the Amplify component. Examples of these variation props are `size` or `variation`.
...
In the example above, the color of the view will be `blue` because the stlyed component will take precedence over the classname CSS.
...
<Block name="JSS">
[JSS](https://github.com/cssinjs/jss/tree/master/packages/react-jss) is a lib for generating Style Sheets with Javascript.
...
<Block name="Emotion">
[Emotion](https://github.com/emotion-js/emotion) is a performant and flexible CSS-in-JS library. It allows you to style apps quickly with string or object styles.
