...
To change the directionality of the App text and layout in your application to right to left (RTL), add the `direction` prop with value `rtl` to your `ThemeProvider`:
