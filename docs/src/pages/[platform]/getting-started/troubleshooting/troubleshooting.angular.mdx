...
### Problems with `OnPush` Change Detection Strategy

The Authenticator component currently does not support use of the `OnPush` Change Detection Strategy. Please use `Default` instead.
