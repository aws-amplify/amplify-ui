...
When you use Connected components and you are supposed to see the folow errors from `aws-crt` and `encoding` on the server:
...
It will not affect the use and functionality. This is a known transitive issue from SDKs. The issue is currently tracked [here](https://github.com/aws-amplify/amplify-js/issues/11030).
