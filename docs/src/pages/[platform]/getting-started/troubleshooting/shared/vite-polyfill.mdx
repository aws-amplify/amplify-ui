...
**3.** (Optional for TS users) If you run into TypeScript strict errors from `aws-amplify` you may need to update the `tsconfig.json` file with the following config:
