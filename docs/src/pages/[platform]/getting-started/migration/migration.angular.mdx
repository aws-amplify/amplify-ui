...
#### Automatic signin on signup logic moved to `aws-amplify`. 

##### 1. Update the handleSignUp function override call
...
```
##### 2. Update to the latest version of the `aws-amplify` library.
