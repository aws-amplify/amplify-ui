...
#### 4. React 16.14.0 or higher is required

We bumped up the minimum React version support from `16.8.0` to `16.14.0`. Therefore, a minimum `16.14.0` of React version is required to use 4.x.
