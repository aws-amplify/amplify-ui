...
Install the 3.x version of the `@aws-amplify/ui-vue` library.

<Tabs>
<TabItem title="npm">

```shell
npm install aws-amplify @aws-amplify/ui-vue@3.x
```

</TabItem>
<TabItem title="yarn">
```shell
yarn add aws-amplify @aws-amplify/ui-vue@3.x
```
...
##### 1. Update custom handleSignUp function override calls
