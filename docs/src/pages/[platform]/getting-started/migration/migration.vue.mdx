...
sense of the changes please check out the [Headers and Footers](../components/authenticator/customization#headers--footers) section.

### Form Fields

The latest version of the `Authenticator` has a different format for the `formFields` prop. It also no long accepts
`inputProps` nor `hint`. Instead it's recommended that you use the [Headers and Footers Slots](../components/authenticator/customization#headers--footers) or use the
[Sign Up Fields custimization](../components/authenticator/customization#sign-up-fields). For more information on form field customizations
please see the [Form Field Customization](../components/authenticator/customization#form-field-customization) section.

### CSS Styling

The latest version of the `Authenticator` has a completely different set of CSS variables. Please look over the [Amplify CSS Variables](../components/authenticator/customization#styling) section for more information.
