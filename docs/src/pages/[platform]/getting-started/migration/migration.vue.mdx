...
## 3.x to 4.x
### Installation
Install the 4.x version of the `@aws-amplify/ui-vue` library.

<Tabs>
<TabItem title="npm">
<TerminalCommand command="npm install @aws-amplify/ui-vue@4.x" />
</TabItem>
<TabItem title="yarn">
<TerminalCommand command="yarn add @aws-amplify/ui-vue@4.x" />
</TabItem>
</Tabs>

### Update and usage

`@aws-amplify/ui-vue@4.x` introduces the following breaking changes:

#### 1. `@aws-amplify/ui-vue@4.x` updates translation key for korean language from `kr` to `ko`.
