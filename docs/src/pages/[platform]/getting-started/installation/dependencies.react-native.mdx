...
<ExampleCode>
```shell
expo install @aws-amplify/ui-react-native aws-amplify@5.x react-native-safe-area-context @react-native-async-storage/async-storage @react-native-community/netinfo
```
</ExampleCode>
</Example>
