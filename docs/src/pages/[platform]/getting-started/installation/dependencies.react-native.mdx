...
Install `@aws-amplify/ui-react-native` and 'aws-amplify' its dependencies using the [Expo CLI](https://expo.dev/tools#cli) to ensure installion of native module dependency versions compatible with your Expo app:
