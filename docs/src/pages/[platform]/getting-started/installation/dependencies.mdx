...
<InlineFilter filters={['angular']}>
  For the latest version, install `@aws-amplify/ui-angular` with [npm](https://www.npmjs.com/) or [yarn](https://yarnpkg.com/):
...
<InlineFilter filters={['react-native']}>
  ...
  <Tabs.Panel value="react-native">
   ...
   For the latest version, install `@aws-amplify/ui-react-native` and its dependencies with [npm](https://www.npmjs.com/) or [yarn](https://yarnpkg.com/):
...
<InlineFilter filters={['react']}>
  For the latest version, install `@aws-amplify/ui-react` with [npm](https://www.npmjs.com/) or [yarn](https://yarnpkg.com/):
...
<InlineFilter filters={['vue']}>
  For the latest version, install `@aws-amplify/ui-vue` with [npm](https://www.npmjs.com/) or [yarn](https://yarnpkg.com/):
