...
To add a [custom theme](/theming), wrap your app in the `ThemeProvider` component and include the default styling.
...
> The `ThemeProvider` helps direct [theming](/theming) to all the Amplify components in your application. It can optionally be used with a [theme object](/theming#theme-object), to set the look and feel of your app.
