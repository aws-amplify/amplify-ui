...
Currently, the [Authenticator](../connected-components/authenticator) is available for React, Angular, Vue, and Flutter. The Android, Swift and React Native Authenticators are currently in developer preview. Primitive components are available for React, with Angular, Vue, and React Native coming soon. 
