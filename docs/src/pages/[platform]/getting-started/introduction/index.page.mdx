...
Currently, the [Authenticator](../connected-components/authenticator) is available for React, Angular, Vue, Flutter and Android. Primitive components are available for React, with Angular, Vue, and React Native coming soon. 
