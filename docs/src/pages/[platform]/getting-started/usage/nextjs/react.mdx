...
In this brief tutorial, we're going to build a basic shopping card component using [Next.js](https://nextjs.org/docs/getting-started/installation) and Amplify UI. Then, we'll elaborate on our shopping card to play with the possibilities of using Amplify UI.
