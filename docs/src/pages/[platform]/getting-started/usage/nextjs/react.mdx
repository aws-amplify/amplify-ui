...
In this getting started guide, we placed `"use client"` at the top of `page.jsx` for demonstration purposes. For your application, please see [troubleshooting](/getting-started/troubleshooting#next-134-react-server-components) for more information.
    </Alert>
