...
First, create a Client Component file _AmplifyComponents.jsx_ that re-exports `Button`. Make sure to place `'use client'` at the top of _AmplifyConnectedComponents.jsx_ to let Nextjs know that should be handled as a Client Component.
...
```tsx
// app/page.jsx
import { Button } from './AmplifyComponents';
