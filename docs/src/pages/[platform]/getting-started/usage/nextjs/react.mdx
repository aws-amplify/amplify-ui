...
### App Router
Next.js 13.4+ introduced the [App Router](https://nextjs.org/docs/app/building-your-application/routing#the-app-directory) with the usage of [React Server Components](https://nextjs.org/docs/getting-started/react-essentials#server-components).  Amplify UI components are highly interactive and must be used as Client Components. For more info, visit Next.js [third party package documentation](https://nextjs.org/docs/getting-started/react-essentials#third-party-packages).

If you are using Next.js [Pages Router](https://nextjs.org/docs/pages/building-your-application/routing/pages-and-layouts), no changes are required to use Amplify UI components.
...
Open up the project in your IDE and replace the contents of the `pages/index.js` with the code below:
  ...
  ```
    ...
    <Alert variation="info" role="none">
      Next.js 13.4+ introduced [app directory](https://nextjs.org/docs/app/building-your-application/routing#the-app-directory) with the usage of [Server Components](https://nextjs.org/docs/getting-started/react-essentials#server-components). For simplicity, in this guide, we placed `"use client"` at the top of `page.jsx` to mark it as a Client Component, but you could also wrap the UI components in your own Client Component.
    </Alert>
