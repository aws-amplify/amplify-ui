...
An example below is shown for using Amplify UI `Link` component:

First, create a Client Component file _AmplifyComponents.jsx_ that re-exports `Link`. Make sure to place `'use client'` at the top of _AmplifyComponents.jsx_ to let Nextjs know that the contents of the file should be handled as a Client Component.
