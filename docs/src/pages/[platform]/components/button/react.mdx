...
import { OverlayUseCase, IconButtonExample, ButtonThemeExample, PrimaryVariation, LinkVariation, OutlineVariation, BrandUseCase } from './examples';
...
<Message colorTheme="info" variation="filled">
  <MessageContent><MessageTitle>overlay color theme</MessageTitle>Use the overlay color theme when you don't necessarily want to imply an action via color, or where button color might clash with the background.</MessageContent>
</Message>
