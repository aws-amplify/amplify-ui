  ...
  propsLists: [
    {
      ...
      props: [
        ...
        },
        {
          ...
          isOptional: true,
          type: "extends TextProps,     Pick<FieldProps, 'descriptiveText' | 'labelHidden'>",
          description: '',
        },
        {
          name: 'FieldErrorMessageProps',
          isOptional: true,
          type: "extends TextProps,     Pick<FieldProps, 'errorMessage'>,     Pick<InputProps, 'hasError'>",
          description: '',
        },
        {
          name: 'hasError',
        ...
        },
        {
          ...
          isOptional: true,
          type: 'extends TextFieldOptions,     TextAreaProps',
          description: '',
        },
        {
