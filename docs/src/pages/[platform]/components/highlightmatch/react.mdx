...
import { HighlightMatchDefaultExample, HighlightMatchHighlightStylesExample } from './examples';
...
<Example>
  <HighlightMatchHighlightStylesExample />
  
  <ExampleCode>

```tsx file=./examples/HighlightMatchHighlightStylesExample.tsx
