...
***Note***: When you use Autocomplete in controlled way, it is your responsibility to set up `onClear` and `onSelect` event listeners
other than `onChange` since the input value is under your control.
