...
**_Note_**: When using Autocomplete in controlled way, you are also responsible to set up `onClear` and `onSelect` event handlers
...
**_Note_**: When you create your own filtering logic, match highlighting will be disabled. If you want to enable it,
