...
<Badge variation="info">Usage note:</Badge> The Alert component has an ARIA `alert`
role by default which has some
<Link href="#accessibility">accessibility implications</Link>
...
<>
  <Alert variation="error" heading="System Error">
    Red Alert!
  </Alert>
  <Alert>Default Alert styling unaffected</Alert>
</>;
