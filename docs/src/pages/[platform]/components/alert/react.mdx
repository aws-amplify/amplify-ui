...
import { Example, ExampleCode, ExamplePreview } from '@/components/Example';
...
<Example>
  ...
  <ExampleCode reactExport='DefaultAlertExample'>
...
<Example>
  ...
  <ExampleCode reactExport='AlertVariationsExample'>
...
<Example>
  ...
  <ExampleCode reactExport='AlertHeadingExample'>
...
<Example>
  <ExamplePreview reactExport="AlertIconExample">
    <AlertIconExample />
  </ExamplePreview>
...
<Example>
  ...
  <ExampleCode reactExport="DismissibleAlertExample">
...
<Example>
  <ExamplePreview reactExport="OnDismissAlertExample">
    <OnDismissAlertExample />
  </ExamplePreview>
...
<Example>
  ...
  <ExampleCode reactExport='AlertStylePropsExample'>
...
Please see the <Link isExternal={true} href="https://www.w3.org/WAI/ARIA/apg/example-index/alert/alert.html">ARIA Authoring Practices Guide for the `alert` role</Link> for more information and use cases.
