  ...
  propsLists: [
    {
      ...
      props: [
        ...
        },
        {
          ...
          description:
            'The component to be repeated Same interface as Array.prototype.map',
        },
        {
          name: 'className',
          isOptional: true,
        ...
        },
        {
          name: 'searchFilter',
          isOptional: true,
          type: '(item: unknown, searchText: string) => boolean',
        ...
        },
        {
          ...
          description:
            "Collection type. This will be used to determine collection wrapper component. Default: 'list'",
        },
      ],
      utilityProps: [
        {
