      ...
      props: [
        {
          ...
          type: 'string',
          description:
            'Alternative text description of the image (required). See: [MDN](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#attr-alt)',
        },
        {
          name: 'className',
          isOptional: true,
        ...
        },
        {
          name: 'objectFit',
          isOptional: true,
          type: 'ResponsiveStyle<Property.ObjectFit>',
          description:
        ...
        },
        {
          name: 'objectPosition',
          isOptional: true,
          type: 'ResponsiveStyle<Property.ObjectPosition<0 | (string & {})>>',
          description:
        ...
        },
        {
          name: 'onError',
          isOptional: true,
          type: '(error: string | React.SyntheticEvent<HTMLImageElement, Event>) => void',
          description: 'Handles error events on image.',
        },
        {
          name: 'onLoad',
          isOptional: true,
          type: '(event: React.SyntheticEvent<HTMLImageElement, Event>) => void',
        ...
        },
        {
          ...
          type: 'string',
          description:
            'Set of image source sizes. See: [MDN](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#attr-sizes)',
        },
        {
          name: 'src',
          isOptional: false,
        ...
        },
        {
          ...
          type: 'string',
          description:
            'Possible image sources for the browser to use. See: [MDN](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#attr-srcset)',
        },
        {
          name: 'style',
          isOptional: true,
