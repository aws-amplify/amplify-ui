...
To change the HTML element rendered by the View, use the `as` prop.
...
View will accept any of the standard HTML attributes that its underlying HTML element accepts. View renders a `<div>` by default.
