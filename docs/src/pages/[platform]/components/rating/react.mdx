...
You can customize the appearance of all Rating components in your application with a [Theme](/theming).
...
<Example>
  ...
  ```jsx file=./examples/RatingThemeExample.tsx
...
<ComponentStyleDisplay componentName="Rating" />
