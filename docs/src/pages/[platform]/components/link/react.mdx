...
You can use a Link with any React routing libraries that support custom component. Below is an example using Link with React Router v5, in which custom navigation component is allowed by passing it through the `component` prop:
