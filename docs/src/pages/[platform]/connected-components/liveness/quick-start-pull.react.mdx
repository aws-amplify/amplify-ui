...
If you already have Cognito set up or do not want to use the Amplify CLI to generate Cognito resources, you can follow the documentation for in the [existing resources tab](https://docs.amplify.aws/lib/auth/getting-started/q/platform/js/#set-up-backend-resources) or check out the code snippet below.
