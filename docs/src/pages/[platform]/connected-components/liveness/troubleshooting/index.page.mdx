...
<Fragment platforms={['android', 'swift']}>
...
Yes, this use case is supported.  Please select "Self Managed Cognito Resource" in [Step 1 of the setup](./#step-1-configure-auth).