...
The websocket connection to the Rekognition streaming service will time out after 5 seconds if a connection is not made. This often happens due to slow network speeds. If you encounter this issue, try using a different network or testing your network latency.
