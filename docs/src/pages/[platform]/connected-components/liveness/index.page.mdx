...
The Amplify UI FaceLivenessDetector is powered by [Amazon Rekognition Face Liveness](https://aws.amazon.com/rekognition/). The FaceLivenessDetector supports two types of verification challenges:
