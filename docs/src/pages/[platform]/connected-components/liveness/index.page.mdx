...
Amplify UI FaceLivenessDetector is powered by [Amazon Rekognition Face Liveness](https://aws.amazon.com/rekognition/). The following screenshots shows an example of FaceLivenessDetector in action.
