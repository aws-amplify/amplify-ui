...
> See [Rekognition documentation](https://docs.aws.amazon.com/rekognition/latest/dg/recommendations-liveness.html) for best practices when using the `FaceLivenessDetector` component
