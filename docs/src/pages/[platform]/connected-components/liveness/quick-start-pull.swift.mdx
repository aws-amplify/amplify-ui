...
<Tabs.Container defaultValue="Amplify CLI">
  <Tabs.List>
    <Tabs.Tab value="Amplify CLI">Amplify CLI</Tabs.Tab>
    <Tabs.Tab value="Existing Cognito Resource">Existing Cognito Resource</Tabs.Tab>
    <Tabs.Tab value="Self Managed Cognito Resource">Self Managed Cognito Resource</Tabs.Tab>
    <Tabs.Tab value="Custom Credentials Provider">Custom Credentials Provider</Tabs.Tab>
  </Tabs.List>
