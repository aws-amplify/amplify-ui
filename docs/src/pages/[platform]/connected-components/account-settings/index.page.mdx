...
<Alert variation="warning">
  Account Settings components require end user to be authenticated. You can use the [`Authenticator`](https://ui.docs.amplify.aws/react/connected-components/authenticator) component to add authentication UI to your application.
</Alert>
