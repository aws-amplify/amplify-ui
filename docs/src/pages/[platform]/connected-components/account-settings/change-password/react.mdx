...
Default components are accessible through `ChangePassword.COMPONENT_NAME` (e.g. `ChangePassword.NewPassword`) for your convenience. This is useful if you're interesting in modifying just a small fraction of UI, instead of overriding the whole component.
