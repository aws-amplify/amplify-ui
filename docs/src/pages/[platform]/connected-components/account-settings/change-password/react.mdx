import { Alert, Expander, ExpanderGroup } from '@aws-amplify/ui-react';
...
<ExpanderGroup type="single">
  <Expander title="PasswordFields" value="password-fields">
...
```
  ...
  <Expander title="SubmitButton" value="submit-button">
