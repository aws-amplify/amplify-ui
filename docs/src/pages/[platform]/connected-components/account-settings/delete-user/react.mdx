import { Alert, Expander, ExpanderGroup, ScrollView } from '@aws-amplify/ui-react';
...
<ExpanderGroup type="single">
  <Expander title="DeleteButton" value="delete-button">
...
```
  ...
  <Expander title="ErrorMessage" value="error-message">
...
```
  ...
  <Expander title="WarningView" value="warning-view">
