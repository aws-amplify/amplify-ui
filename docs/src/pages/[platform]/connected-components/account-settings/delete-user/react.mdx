...
function App() {
  ...
  return <AccountSettings.DeleteUser onSuccess={handleSuccess} />;
}
```
...
import { AccountSettings, DeleteUser } from '@aws-amplify/ui-react';
...
<Alert variation="warning">
  ...
  or html attributes like `type` are passed correctly. If you're providing your
  own custom components, make sure required props are passed onto your elements.
</Alert>
...
```jsx
import { AccountSettings, Heading, Text } from '@aws-amplify/ui-react';
