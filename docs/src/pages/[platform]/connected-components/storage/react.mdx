...
To use Storage components with the Authenticator, such as when loading private or protected images, you'll first need to configure Amplify as shown below. 
<Example>
  <Image alt='cat' src='/cats/1.jpg' width="400px" height="400px" />
  <ExampleCode>
    ```jsx file=./ConfigureAmplify.tsx
    ```
  </ExampleCode>
</Example>
