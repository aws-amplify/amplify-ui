...
<Alert role="none" variation="info" heading="Gen 1">
  Using Gen 1? Check out the [Gen 1 Storage documentation](https://docs.amplify.aws/gen1/react/build-a-backend/storage/).
</Alert>