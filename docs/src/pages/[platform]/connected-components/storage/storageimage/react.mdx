...
When using private or protected images, you will need to wrap your app in the `Authenticator` component, as shown in [Using Storage with the Authenticator](/connected-components/storage#using-storage-with-the-authenticator)
<Example>
  <Image alt='cat' src='/cats/1.jpg' width="400px" height="400px" />
  <ExampleCode>
    ```jsx file=./examples/ProtectedStorageImageExample.tsx
    ```
  </ExampleCode>
</Example>
