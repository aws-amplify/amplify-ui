...
The Storage Browser includes built-in file preview functionality that allows users to preview images, videos, text files, and other supported file types directly within the interface. You can customize the file preview behavior through four main configuration options:
