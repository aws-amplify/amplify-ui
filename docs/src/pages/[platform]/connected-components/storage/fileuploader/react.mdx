...
FileUploaderComponentsExample, LevelExample, VariationExample, AutoUploadExample, MaxFileCountExample,
MaxFileSizeExample, MultipleExample, ResumableExample, ShowImagesExample, FileUploaderSuccessExample, PreviewerComponentsExample, TrackerComponentsExample, UploadButtonComponentsExample } from './examples'
...
The `shouldAutoUpload` prop will automatically start the upload after a file is selected. The default is `false`.

<Example>
  <AutoUploadExample />
  
  <ExampleCode>
    ```jsx file=./examples/AutoUploadExample.tsx
    ```
  </ExampleCode>
</Example>
