...
<Fragment platforms={['react', 'react-native']}>
  {({ platform }) => import(`./fragments/overview.${platform}.mdx`)}
</Fragment>

## Prerequisites

<Fragment platforms={['react', 'react-native']}>
  {({ platform }) => import(`./fragments/prereqs.${platform}.mdx`)}
</Fragment>
...
<Fragment platforms={['react', 'react-native']}>
  {({ platform }) => import(`./examples/getting-started.${platform}.mdx`)}
</Fragment>
...
<Fragment platforms={['react', 'react-native']}>
  {({ platform }) => import(`./examples/use-messaging.${platform}.mdx`)}
</Fragment>
...
<Fragment platforms={['react', 'react-native']}>
  {({ platform }) => import(`./examples/custom-components.${platform}.mdx`)}
</Fragment>
...
<Fragment platforms={['react', 'react-native']}>
  {({ platform }) => import(`./examples/custom-style.${platform}.mdx`)}
</Fragment>
