...
[Amplify In-App Messaging API](https://docs.amplify.aws/lib/in-app-messaging/overview/q/platform/react/)
and [Amazon Pinpoint](https://docs.aws.amazon.com/pinpoint/latest/userguide/channels-inapp.html).

## Getting Started

> Prerequisites: 
> - [Create an In-App Messaging campaign](https://docs.amplify.aws/lib/in-app-messaging/prerequisites/q/platform/js/)
