...
To override a call you must create a new `services` object with an `async` `handle*` function that returns the callback function passed in as an argument.
...
<ResponsiveTable labelWidth="10rem">
  <TableHead>
    <TableRow>
      ...
      <TableCell as="th">Callback signature</TableCell>
    </TableRow>
  </TableHead>
  <TableBody>
    <TableRow>
      ...
      <ResponsiveTableCell label="formData Properties">`signUp(username, password, attributes)`</ResponsiveTableCell>
    </TableRow>
    <TableRow>
      ...
      <ResponsiveTableCell label="formData Properties">`signIn(username, password)`</ResponsiveTableCell>
    </TableRow>
    <TableRow>
      ...
      <ResponsiveTableCell label="formData Properties">`confirmSignIn(user, code, mfaType)`</ResponsiveTableCell>
    </TableRow>
    <TableRow>
      ...
      <ResponsiveTableCell label="formData Properties">`confirmSignUp(username, code)`</ResponsiveTableCell>
    </TableRow>
    <TableRow>
      ...
      <ResponsiveTableCell label="formData Properties">`forgotPassword(username)`</ResponsiveTableCell>
    </TableRow>
    <TableRow>
      ...
      <ResponsiveTableCell label="formData Properties">`forgotPasswordSubmit(username, code, password)`</ResponsiveTableCell>
    </TableRow>
  </TableBody>
</ResponsiveTable>
