...
<Fragment useCommonWebContent platforms={['web', 'react-native', 'android']}>
  {({ platform }) =>
...
<Fragment useCommonWebContent platforms={['web', 'flutter', 'android']}>
...
<Fragment platforms={['flutter', 'android']}>
  {({ platform }) =>
