...
export const latestVersion = MAJOR_VERSIONS['vue'][0];
export const prevVersion = MAJOR_VERSIONS['vue'][1];

  <Tabs.Container defaultValue={latestVersion}>
    <Tabs.List>
      <Tabs.Item value={latestVersion}>ui-vue v{latestVersion} (latest)</Tabs.Item>
      <Tabs.Item value={prevVersion}>ui-vue v{prevVersion}</Tabs.Item>
    </Tabs.List>
