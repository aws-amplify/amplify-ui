...
<Tabs>
  <TabItem title="Sign In">
    ...
    <Fragment platforms={['react', 'vue', 'angular', 'flutter']} useCommonWebContent>
      {({ platform }) =>
...
<Fragment useCommonWebContent platforms={['react', 'vue', 'angular', 'flutter']}>
  {({ platform }) => import(`./socialProviders.${platform}.mdx`)}
</Fragment>

<Fragment useCommonWebContent platforms={['react', 'vue', 'angular']}>
