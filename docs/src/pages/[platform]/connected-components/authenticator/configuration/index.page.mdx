...
<Tabs.Container defaultValue="sign-in">
  <Tabs.List>
    ...
    <Tabs.Tab value="reset-password">Reset Password</Tabs.Tab>
  </Tabs.List>
...
<Tabs.Container defaultValue="verification-attributes">
  <Tabs.List>
    <Tabs.Tab value="verification-attributes">Verification Attributes</Tabs.Tab>
    <Tabs.Tab value="all-attributes">All Attributes</Tabs.Tab>
  </Tabs.List>
