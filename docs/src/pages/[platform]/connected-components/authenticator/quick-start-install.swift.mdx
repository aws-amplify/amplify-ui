...
- [**Amplify UI Swift - Authenticator**](https://github.com/aws-amplify/amplify-ui-swift-authenticator): Enter its GitHub URL (`https://github.com/aws-amplify/amplify-ui-swift-authenticator`), select **Up to Next Major Version**, type `1.0.0-dev-preview` and click **Add Package**
