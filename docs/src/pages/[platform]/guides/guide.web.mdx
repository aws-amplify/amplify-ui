...
If you have an idea for a guide that you'd like to write yourself, you are more than welcome to read the [CONTRIBUTING](https://github.com/aws-amplify/amplify-ui/blob/main/CONTRIBUTING.md) guide and submit a pull request. Make sure to submit an issue with the details of your idea before you submit your PR, so you can receive guidance and feedback.
