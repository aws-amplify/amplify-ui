import { Alert, Link, Tabs, TabItem } from '@aws-amplify/ui-react';
...
<Alert variation="warning" role="none">
  If your CSS library depends on injecting styles into the DOM, make sure they are being injected <b>after</b> Amplify UI's styles. In other words, ensure the style tag for Amplify UI is listed above your custom styles in the head tag. If Amplify UI's styles are injected after, then your custom styles will likely be unset. See <Link href="https://github.com/aws-amplify/amplify-ui/issues/3533">here</Link> for more info.
</Alert>
