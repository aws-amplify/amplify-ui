...
<Tabs.Container defaultValue="Styled Components">
  <Tabs.List>
    <Tabs.Tab value="Styled Components">Styled Components</Tabs.Tab>
    <Tabs.Tab value="JSS">JSS</Tabs.Tab>
    <Tabs.Tab value="Emotion">Emotion</Tabs.Tab>
    <Tabs.Tab value="Aphrodite">Aphrodite</Tabs.Tab>
  </Tabs.List>
