...
export function JSSText() {
  const classes = useStyles();

  //use the JSS create classes in the Amplify ui className
  return <Text className={classes.styledText}>This is my JSS Text </Text>;
}
```
...
export function JSSText() {
  ...
  return <Text className={classNames}>This is my JSS Text </Text>;
}
```
...
export function JSSButton() {
  const classes = useStyles();

  return <Button className={classes.styledButton}>Button</Button>;
}
```
