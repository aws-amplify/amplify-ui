...
<Tabs>
  <TabItem title="npm">
    <TerminalCommand command="npm install @aws-amplify/ui-react aws-amplify@5.x react-router-dom@6" />
  </TabItem>
  <TabItem title="yarn">
    <TerminalCommand command="yarn add @aws-amplify/ui-react aws-amplify@5.x react-router-dom@6" />
  </TabItem>
</Tabs>
