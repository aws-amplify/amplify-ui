...
<Alert variation="info">
  For instructions on setting up authenticator and base styling please see <Link href={`/${props.framework}/components/authenticator#quick-start`}>#quick-start</Link>
</Alert>
