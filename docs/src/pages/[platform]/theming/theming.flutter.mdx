...
The live examples opt into usage of Material 3 which will become the default in a future version of Flutter. See <Link isExternal href="https://api.flutter.dev/flutter/material/ThemeData/useMaterial3.html">useMaterial3</Link> for more info.
</Alert>
