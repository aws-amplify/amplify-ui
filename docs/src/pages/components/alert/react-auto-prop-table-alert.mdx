...
<Expander type="multiple" defaultValue={['AlertProps']}>
  
<ExpanderItem title="AlertProps" value="AlertProps">
    <ReactMarkdown
      remarkPlugins={[remarkGfm]}
      children={`
| name | type | default | description |
| ---- | ---- | ------- | ----------- |
| heading | ReactNode | - | The heading property will affect the content of the Alert heading. |
| variation | AlertVariations | - | The variation property will affect the background color of the Alert. |
| isDismissible | boolean | false | The isDismissible property will affect whether the user can dismiss (close) the Alert. Defaults to false (not dismissible). |
| onDismiss | () =&#62; void | - | The onDismiss callback will be called when the user dismisses (closes) the Alert. |
| hasIcon | boolean | true | The hasIcon property will determine whether or not an icon is displayed on the Alert. Defaults to true (icon displayed). |
| buttonRef | Ref&#60;HTMLButtonElement&#62; | - | The ref will be forwarded to the dismiss button |
