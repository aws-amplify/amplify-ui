...
| as | ElementType | / |  |
| autoComplete | string | current-password | Password autocomplete type See: https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete#values |
...
| hideShowPassword | boolean | false | For password fields, will hide the "show password" button |
...
| name | string | / | Name of the field. Submitted with the form as part of a name/value pair. |
...
| role | React.AriaRole | / |  |
| showPasswordButtonRef | Ref&#60;HTMLButtonElement&#62; | / | Forwarded ref for access to show password button DOM element |
