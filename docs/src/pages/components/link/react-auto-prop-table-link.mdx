...
| as | ElementType | a |  |
| children | ReactNode | / | Children to be rendered inside the Link component |
| className | string | / | Additional CSS class name for component |
| id | string | / | Unique identifier |
| isDisabled | boolean | / |  |
| isExternal | boolean | / | Boolean value indicating an external link sets the rel attribute to "noopener noreferrer" |
| ref | Ref&#60;HTMLAnchorElement&#62; | / |  |
| role | React.AriaRole | / |  |
| style | CSSProperties | / |  |
| testId | string | / | Used to provide a &#96;data-testid&#96; attribute for testing purposes |
| to | string | / | A string representation of the URL path |
