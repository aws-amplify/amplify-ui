...
The `descriptiveText` prop will only be visible when `label` is not hidden (i.e., `isLabelHidden={false}`). You can use it to provide some additional description of the field.
