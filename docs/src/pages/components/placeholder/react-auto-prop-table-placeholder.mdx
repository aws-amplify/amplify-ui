...
<Expander type="multiple" defaultValue={['PlaceholderProps']}>
  
<ExpanderItem title="PlaceholderProps" value="PlaceholderProps">
    <ReactMarkdown
      remarkPlugins={[remarkGfm]}
      children={`
| name | type | default | description |
| ---- | ---- | ------- | ----------- |
| isLoaded | boolean | false | If true, the placeholder won't show, if false the placeholder will show. |
| size | Sizes | - | Controls the display size of placeholder |
