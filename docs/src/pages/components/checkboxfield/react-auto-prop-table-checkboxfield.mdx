...
| labelPosition | LabelPositions | / | Position of label in relation to the checkbox, default is 'start' |
...
| value | string | / | The submitted value when checked Shows on form submission as key pair &#96;name:value&#96; |
