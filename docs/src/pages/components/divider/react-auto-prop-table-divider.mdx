...
| isDisabled | boolean | / |  |
| label | string | / | Adds text to the divider, usually something like "or" to separate 2 things. |
| orientation | DividerOrientations | horizontal | Controls whether the divider is oriented horizontally or vertically. |
| ref | Ref&#60;HTMLHRElement&#62; | / |  |
| role | React.AriaRole | / |  |
| size | Sizes | "small" | Size of the divider (height for a horizontal divider, width for vertical) |
| style | CSSProperties | / |  |
