...
| defaultValue | number | / | Use this to provide a default value for an uncontrolled field |
...
| onDecrease | () =&#62; void | / |  |
| onIncrease | () =&#62; void | / |  |
| onStepChange | (value: number) =&#62; void | / | TODO: Extends StepperField props from Omit&#60;TextFieldProps, 'onChange'&#62;, after removing [key: string]: any from the base type and rename onStepChange to onChange |
...
| type | "number" | / | Input field type (only applies when isMultiline = false) |
| value | number | / | If value is provided, this will be a controlled field |
