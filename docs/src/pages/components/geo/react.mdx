...
> Prerequisites: Install`@aws-amplify/ui-react`with [npm](https://www.npmjs.com/) or [yarn](https://yarnpkg.com/) and [create a Geo backend](https://docs.amplify.aws/lib/geo/getting-started/q/platform/js/).
