...
import { LocalStylingExample } from './OLDexamples';
...
- `dialCodeList`: An array of dial codes (strings) used as options in the country or region code selector
...
You can customize the appearance of all `PhoneNumberField`'s in your application with a [Theme](/theming).

<Example>
  <ThemingExample />
  <ExampleCode>
```jsx file=./examples/ThemingExample.tsx
...
<Example>
  <ClassNameExample />
  <ExampleCode>
```jsx file=./examples/ClassNameExample.tsx
