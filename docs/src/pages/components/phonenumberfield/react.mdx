...
```jsx
<Flex>
  <PhoneNumberField defaultCountryCode="+1" label="Small" size="small" isLabelHidden={true} />
  <Button size="small">Small</Button>
</Flex>

<Flex>
  <PhoneNumberField defaultCountryCode="+1" label="Default" isLabelHidden={true} />
  <Button>Default</Button>
</Flex>

<Flex>
  <PhoneNumberField defaultCountryCode="+1" label="Large" size="large" isLabelHidden={true} />
