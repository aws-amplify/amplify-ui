...
| as | ElementType | / |  |
| autoComplete | string | tel-national | Specifies permissions for browser UA to autocomplete field @link https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete |
...
| countryCodeLabel | string | Country code |  |
| countryCodeName | string | / |  |
| countryCodeRef | Ref&#60;HTMLSelectElement&#62; | / | Forwarded ref for access to Country Code select DOM element |
...
| type | "tel" | / | Input field type (only applies when isMultiline = false) |
