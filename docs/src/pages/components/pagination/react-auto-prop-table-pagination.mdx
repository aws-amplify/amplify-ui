...
| currentPage | number | 1 | Index of the current page. (starting from 1) |
| hasMorePages | boolean | false | Optionally indicates whether there are more pages after &#96;totalPages&#96;. Can be combined with &#96;totalPages&#96; to enable the next button when reaching the last page. |
