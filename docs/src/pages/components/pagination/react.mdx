...
Import the Pagination component. Pagination is a controlled component, so you'll need to handle state using these callback functions:
...
<Example>
  ...
  <ExampleCode>
    ...
    /* styles.css */
    .amplify-pagination {
      --amplify-components-pagination-current-background-color: red;
    }
    ```
  </ExampleCode>
  <ExampleCode>
...
<Example>
  ...
  <ExampleCode>
    ...
    .my-custom-pagination {
      --amplify-components-pagination-current-background-color: blue;
      --amplify-components-pagination-button-hover-background-color: green;
    }
    ```
  </ExampleCode>
  <ExampleCode>
    ...
    // simplified demo
    <Pagination totalPages={7} className="my-custom-pagination" />
    ```
...
<Example>
  ...
  <ExampleCode>
    ...
    // simplified demo
    <Pagination totalPages={5} backgroundColor="lavender" padding="1rem" />
    ```
