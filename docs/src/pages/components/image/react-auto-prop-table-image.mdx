...
| ---- | ---- | ------- | ----------- |
| alt | string | / | Alternative text description of the image (required) @see https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#attr-alt |
| ariaLabel | string | / |  |
...
| isDisabled | boolean | / |  |
| objectFit | ResponsiveStyle&#60;ObjectFit&#62; | / |  |
| objectPosition | ResponsiveStyle&#60;ObjectPosition&#60;0 &#124; (string & \{\})&#62;&#62; | / |  |
| onError | (error: string &#124; SyntheticEvent&#60;HTMLImageElement, Event&#62;) =&#62; void | / | Handles error events on image |
| onLoad | (event: SyntheticEvent&#60;HTMLImageElement, Event&#62;) =&#62; void | / | Handles loading event on image |
| ref | Ref&#60;HTMLImageElement&#62; | / |  |
| role | React.AriaRole | / |  |
| sizes | string | / | Set of image source sizes @see https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#attr-sizes |
| src | string | / | URl source for image (required) |
| srcSet | string | / | Possible image sources for the browser to use @see https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#attr-srcset |
| style | CSSProperties | / |  |
