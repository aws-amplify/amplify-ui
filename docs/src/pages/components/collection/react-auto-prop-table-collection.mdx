...
| as | ElementType | / |  |
| autoColumns | ResponsiveStyle&#60;GridAutoColumns&#60;0 &#124; (string & \{\})&#62;&#62; | / |  |
| autoFlow | ResponsiveStyle&#60;GridAutoFlow&#62; | / |  |
| autoRows | ResponsiveStyle&#60;GridAutoRows&#60;0 &#124; (string & \{\})&#62;&#62; | / |  |
...
| items | Item[] | / |  |
| itemsPerPage | number | 10 | Page size (when pagination is enabled) |
| role | React.AriaRole | / |  |
| searchFilter | (item: unknown, searchText: string) =&#62; boolean | (item: unknown, text: string): boolean =&#62; {   if (strHasLength(item)) {     return item.toLowerCase().includes(text.toLowerCase());   }    if (typeof item === 'object' && item !== null) {     return Object.values(item).some((subItem) =&#62; itemHasText(subItem, text));   }    return false; } | Custom search filter (when search is enabled) |
| searchPlaceholder | string | / | Search field placeholder |
| style | CSSProperties | / |  |
| templateAreas | ResponsiveStyle&#60;GridTemplateAreas&#62; | / |  |
| templateColumns | ResponsiveStyle&#60;GridTemplateColumns&#60;0 &#124; (string & \{\})&#62;&#62; | / |  |
| templateRows | ResponsiveStyle&#60;GridTemplateRows&#60;0 &#124; (string & \{\})&#62;&#62; | / |  |
| testId | string | / | Used to provide a &#96;data-testid&#96; attribute for testing purposes |
| type | "list" &#124; "grid" | list | Collection type. This will be used to determine collection wrapper component. |
...
| direction | ResponsiveStyle&#60;FlexDirection&#62; | column | Sets how flex items are placed in the flex container defining the main axis and the direction (normal or reversed). (maps to flex-direction CSS property) |
