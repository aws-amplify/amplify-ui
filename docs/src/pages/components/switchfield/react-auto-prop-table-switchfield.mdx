...
| autoComplete | string | / | Specifies permissions for browser UA to autocomplete field @link https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete |
...
| type | HTMLInputTypeAttribute | / | Input field type |
