...
| defaultValue | string | / | Use this to provide a default value for an uncontrolled field |
...
| labelPosition | LabelPositions | / | Position of label in relation to the radio, default is 'start' |
| name | string | / | Name of the field. Submitted with the form as part of a name/value pair. |
| onChange | ChangeEventHandler&#60;HTMLInputElement&#62; | / | Handle onChange event |
...
| value | string | / | If value is provided, this will be a controlled field |
