...
<Expander type="multiple" defaultValue={['MenuProps']}>
  
<ExpanderItem title="MenuProps" value="MenuProps">
    <ReactMarkdown
      remarkPlugins={[remarkGfm]}
      children={`
| name | type | default | description |
| ---- | ---- | ------- | ----------- |
| menuAlign | "center" &#124; "end" &#124; "start" | start | Alignment of menu against trigger |
| onOpenChange | (isOpen: boolean) =&#62; void | - | Handle open and close event of menu |
| isOpen | boolean | - | Default for controlled menu |
| size | Sizes | - | Size of Menu button and items |
| trigger | ReactNode | MenuButton with IconMenu | Trigger node @note Must forward refs to DOM element |
| triggerClassName | string | - | ClassName to apply to default trigger button Note: only applies if &#96;trigger&#96; prop is null |
