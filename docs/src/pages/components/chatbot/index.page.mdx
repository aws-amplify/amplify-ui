...
<Alert variation="info" heading="Legacy component">
  This component has been migrated from the previous version of Amplify UI, but
  has not been updated in this new version.
</Alert>
