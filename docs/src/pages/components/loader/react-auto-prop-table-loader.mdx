...
<Expander type="multiple" defaultValue={['LoaderProps']}>
  
<ExpanderItem title="LoaderProps" value="LoaderProps">
    <ReactMarkdown
      remarkPlugins={[remarkGfm]}
      children={`
| name | type | default | description |
| ---- | ---- | ------- | ----------- |
| size | Sizes | - | This will set the size of Loader. |
| variation | "linear" | - | This will set the variation of Loader. Available options are linear and none(circular). |
| filledColor | Color | - | This will set the filled color of Loader. |
| emptyColor | Color | - | This will set the empty color of Loader. |
| percentage | number | 0 | This will set the percentage of a determinate Loader. |
| isDeterminate | boolean | false | This will mark the Loader as determinate. |
| isPercentageTextHidden | boolean | false | This will set the visibility of percentage text. |
