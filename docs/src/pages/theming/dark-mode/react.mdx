...
You can also write CSS variables directly to support color modes. If you are using the `colorMode` prop in the `AmplifyProvider` you will write CSS like this to support dark mode:
