...
Amplify UI allows custom fonts to be used in the theme. The font tokens are defined in the `fonts` namespace, you can define your primary font stack and a fallback font stack the same way you would do in CSS
...
_Note: If you are importing Amplify UI React CSS `import '@aws-amplify/ui-react/styles.css'` this needs to be imported before any other CSS to avoid overriding the html `font-family` directive._
