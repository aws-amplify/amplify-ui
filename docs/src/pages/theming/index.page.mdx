...
Amplify UI allows custom fonts to be used in the theme. The font tokens are defined in the `fonts` namespace, you can define your primary font stack and a fallback font stack values the same way you would do in CSS `font-family` rule.
