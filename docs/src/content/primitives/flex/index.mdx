...
```jsx
/* example element */
const NumberBox = ({number}) => <Flex justifyContent="center" alignItems="center" width="15rem" height="3rem" borderRadius="5px" fontWeight="bold" color="white" backgroundColor="#805AD5">{number}</Flex>;
