      ...
      return (
        <Flex direction="column" paddingLeft="2rem" paddingRight="2rem">
          <Flex direction="column" paddingTop="2rem" paddingBottom="1rem">
            ...
            >
              <AmazonIcon />
              <Text as="span">Sign In with Amazon</Text>
            </Button>
            <Button
              className="federated-sign-in-button"
              fontWeight="normal"
            ...
            >
              <AppleIcon />
              <Text as="span">Sign In with Apple</Text>
            </Button>
            <Button
              className="federated-sign-in-button"
              fontWeight="normal"
            ...
            >
              <FacebookIcon />
              <Text as="span">Sign In with Facebook</Text>
            </Button>
            <Button
              className="federated-sign-in-button"
              fontWeight="normal"
      ...
      return (
        <Flex direction="column" paddingLeft="2rem" paddingRight="2rem">
          <Flex direction="column" paddingTop="2rem" paddingBottom="1rem">
            ...
            >
              <AmazonIcon />
              <Text as="span">Sign Up with Amazon</Text>
            </Button>
            <Button
              className="federated-sign-up-button"
              fontWeight="normal"
            ...
            >
              <AppleIcon />
              <Text as="span">Sign Up with Apple</Text>
            </Button>
            <Button
              className="federated-sign-up-button"
              fontWeight="normal"
            ...
            >
              <FacebookIcon />
              <Text as="span">Sign Up with Facebook</Text>
            </Button>
            <Button
              className="federated-sign-up-button"
              fontWeight="normal"
