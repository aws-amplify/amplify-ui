  ...
  propsLists: [
    {
      ...
      props: [
        ...
        },
        {
          ...
          type: 'string | number',
          description:
            'The controlled index of the currently selected tab. This should be used with &#96;onChange&#96; as well to make the component controlled.',
        },
        {
          name: 'defaultIndex',
          isOptional: true,
        ...
        },
        {
          ...
          description:
            'For controlled usage, use the onChange event to listen to when a tab is clicked and update the &#96;currentIndex&#96; accordingly. The index of the tab clicked is passed to onChange.',
        },
        {
          name: 'spacing',
          isOptional: true,
