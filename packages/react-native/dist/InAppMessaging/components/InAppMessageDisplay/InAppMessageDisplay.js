...
var onMessageAction = function (_a) {
    var action = _a.action, url = _a.url;
    handleMessageAction({ action: action, url: url, handleMessageLinkAction: handleMessageLinkAction });
};
function InAppMessageDisplay(_a) {
    var overrideComponents = _a.components, styles = _a.styles;
    var components = React.useMemo(function () { return (__assign(__assign({}, platformComponents), overrideComponents)); }, [overrideComponents]);
    var _b = useMessage({
        components: components,
        onMessageAction: onMessageAction,
        styles: styles,
    }), Component = _b.Component, props = _b.props;
