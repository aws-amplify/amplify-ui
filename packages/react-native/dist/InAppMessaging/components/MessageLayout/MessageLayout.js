...
export default function MessageLayout(_a) {
  var orientation = _a.orientation,
    props = __rest(_a, ['orientation']);
  var body = props.body,
    hasButtons = props.hasButtons,
    hasPrimaryButton = props.hasPrimaryButton,
    hasRenderableImage = props.hasRenderableImage,
    hasSecondaryButton = props.hasSecondaryButton,
    header = props.header,
    image = props.image,
      ...
      <View style={styles.contentContainer}>
        ...
        {hasRenderableImage && (
          <View style={styles.imageContainer}>
            <Image
              source={{
                uri: image === null || image === void 0 ? void 0 : image.src,
              }}
              style={styles.image}
