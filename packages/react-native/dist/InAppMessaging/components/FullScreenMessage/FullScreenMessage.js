...
export default function FullScreenMessage(props) {
  var _a = useDeviceOrientation(),
    deviceOrientation = _a.deviceOrientation,
    isPortraitMode = _a.isPortraitMode;
  var messageProps = useMessageProps(
    props,
    isPortraitMode ? getPortraitStyles : getLandscapeStyles,
    deviceOrientation
  );
  var shouldRenderMessage = messageProps.shouldRenderMessage,
  ...
  var _b = styles,
    wrapper = _b.wrapper,
    messageStyles = __rest(_b, ['wrapper']);
  return (
