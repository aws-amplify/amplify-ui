...
export declare type GetDefaultStyle<AdditionalStyle = unknown> = (
...
export interface BannerMessageStyle extends MessageOverrideStyle {}
export interface CarouselMessageStyle extends MessageOverrideStyle {
  pageIndicatorActive?: StyleProp<ViewStyle>;
  pageIndicatorInactive?: StyleProp<ViewStyle>;
}
export interface FullScreenMessageStyle extends MessageOverrideStyle {}
export interface ModalMessageStyle extends MessageOverrideStyle {}
