 ...
 */
export declare const getComponentButtonStyle: ({
  styleParams,
  buttonType,
 ...
 */
export declare const shouldFillDeviceScreen: (
 ...
 */
export declare const getContainerAndWrapperStyle: ({
  styleParams,
  layout,
  orientation,
 ...
 */
export declare const getPayloadStyle: ({
  body,
  container,
  header,
  primaryButton,
 ...
 */
export declare function getMessageStyles({
  styleParams,
  layout,
  orientation,
