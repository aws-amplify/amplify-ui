...
var DEFAULT_CAROUSEL_INDICATOR_PADDING = (DEFAULT_CAROUSEL_INDICATOR_SIZE * 5) / 3;
/**
...
export var getComponentButtonStyle = function (_a) {
    var _b, _c;
    var styleParams = _a.styleParams, buttonType = _a.buttonType;
    var defaultStyle = styleParams.defaultStyle, payloadStyle = styleParams.payloadStyle, overrideStyle = styleParams.overrideStyle;
    // default component styles defined at the UI component level
    var _d = defaultStyle !== null && defaultStyle !== void 0 ? defaultStyle : {}, _e = _d.buttonContainer, containerDefaultStyle = _e === void 0 ? {} : _e, _f = _d.buttonText, textDefaultStyle = _f === void 0 ? {} : _f;
    // message specific styles in the in-app message payload, overrides default component styles
    var _g = (_b = payloadStyle === null || payloadStyle === void 0 ? void 0 : payloadStyle[buttonType]) !== null && _b !== void 0 ? _b : {}, backgroundColor = _g.backgroundColor, borderRadius = _g.borderRadius, color = _g.color;
    var containePayloadStyle = __assign(__assign({}, (backgroundColor ? { backgroundColor: backgroundColor } : null)), (borderRadius ? { borderRadius: borderRadius } : null));
    ...
    var _h = (_c = overrideStyle === null || overrideStyle === void 0 ? void 0 : overrideStyle[buttonType]) !== null && _c !== void 0 ? _c : {}, _j = _h.container, containerOverrideStyle = _j === void 0 ? {} : _j, _k = _h.text, textOverrideStyle = _k === void 0 ? {} : _k;
    return {
        ...
        container: function (_a) {
            var _b = _a === void 0 ? { pressed: false } : _a, pressed = _b.pressed;
            ...
            // button style
            var containerOverrideFinalStyle = typeof containerOverrideStyle === 'function'
...
export var getContainerAndWrapperStyle = function (_a) {
    var _b, _c, _d, _e;
    var styleParams = _a.styleParams, layout = _a.layout, orientation = _a.orientation;
    var defaultStyle = styleParams.defaultStyle, payloadStyle = styleParams.payloadStyle, overrideStyle = styleParams.overrideStyle;
    var containerDefaultStyle = (_b = defaultStyle === null || defaultStyle === void 0 ? void 0 : defaultStyle.container) !== null && _b !== void 0 ? _b : {};
    var containerPayloadStyle = (_c = payloadStyle === null || payloadStyle === void 0 ? void 0 : payloadStyle.container) !== null && _c !== void 0 ? _c : {};
    var containerOverrideStyle = (_d = overrideStyle === null || overrideStyle === void 0 ? void 0 : overrideStyle.container) !== null && _d !== void 0 ? _d : {};
    var wrapperDefaultStyle = (_e = defaultStyle === null || defaultStyle === void 0 ? void 0 : defaultStyle.wrapper) !== null && _e !== void 0 ? _e : {};
    ...
    var defaultBackgroundColor = containerDefaultStyle.backgroundColor, restContainerDefaultStyle = __rest(containerDefaultStyle, ["backgroundColor"]);
    var messageBackgroundColor = containerPayloadStyle.backgroundColor, restContainerPayloadStyle = __rest(containerPayloadStyle, ["backgroundColor"]);
    // flatten overrideStyle to access override backgroundColor
    var _f = StyleSheet.flatten(containerOverrideStyle), overrideBackgroundColor = _f.backgroundColor, restContainerOverrideStyle = __rest(_f, ["backgroundColor"]);
...
export var getPayloadStyle = function (_a) {
    var _b, _c, _d, _e, _f;
    var body = _a.body, container = _a.container, header = _a.header, primaryButton = _a.primaryButton, secondaryButton = _a.secondaryButton;
    return ({
        body: (_b = body === null || body === void 0 ? void 0 : body.style) !== null && _b !== void 0 ? _b : {},
        container: (_c = container === null || container === void 0 ? void 0 : container.style) !== null && _c !== void 0 ? _c : {},
        header: (_d = header === null || header === void 0 ? void 0 : header.style) !== null && _d !== void 0 ? _d : {},
        primaryButton: (_e = primaryButton === null || primaryButton === void 0 ? void 0 : primaryButton.style) !== null && _e !== void 0 ? _e : {},
        secondaryButton: (_f = secondaryButton === null || secondaryButton === void 0 ? void 0 : secondaryButton.style) !== null && _f !== void 0 ? _f : {},
    });
};
/**
...
export function getMessageStyles(_a) {
    ...
    }), wrapper = _b.wrapper, container = _b.container;
    ...
    var image = [defaultStyle === null || defaultStyle === void 0 ? void 0 : defaultStyle.image, overrideStyle === null || overrideStyle === void 0 ? void 0 : overrideStyle.image];
    var iconButton = {
        // view style applied to icon button
        container: [defaultStyle === null || defaultStyle === void 0 ? void 0 : defaultStyle.iconButton, overrideStyle === null || overrideStyle === void 0 ? void 0 : overrideStyle.closeIconButton],
        // close icon color, only specified as an overrideStyle
        iconColor: overrideStyle === null || overrideStyle === void 0 ? void 0 : overrideStyle.closeIconColor,
    };
    // text style applied to message body and header respectively
    var body = [defaultStyle === null || defaultStyle === void 0 ? void 0 : defaultStyle.body, payloadStyle === null || payloadStyle === void 0 ? void 0 : payloadStyle.body, overrideStyle === null || overrideStyle === void 0 ? void 0 : overrideStyle.body];
    var header = [
        defaultStyle === null || defaultStyle === void 0 ? void 0 : defaultStyle.header,
        payloadStyle === null || payloadStyle === void 0 ? void 0 : payloadStyle.header,
        overrideStyle === null || overrideStyle === void 0 ? void 0 : overrideStyle.header,
    ];
    var _c = defaultStyle !== null && defaultStyle !== void 0 ? defaultStyle : {}, buttonsContainer = _c.buttonsContainer, contentContainer = _c.contentContainer, imageContainer = _c.imageContainer, textContainer = _c.textContainer;
    var styleProps = {
        body: body,
