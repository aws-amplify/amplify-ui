...
var getDeviceOrientation = function () {
    var _a = Dimensions.get('screen'), height = _a.height, width = _a.width;
    return height >= width ? 'portrait' : 'landscape';
};
export default function useDeviceOrientation() {
    var _a = __read(useState(getDeviceOrientation), 2), deviceOrientation = _a[0], setDeviceOrientation = _a[1];
    ...
    return { deviceOrientation: deviceOrientation, isLandscapeMode: isLandscapeMode, isPortraitMode: isPortraitMode };
}
