...
export var DEFAULT_CAROUSEL_INDICATOR_ACTIVE_STYLE = __assign(__assign({}, DEFAULT_CAROUSEL_INDICATOR_STYLE), { backgroundColor: DEFAULT_CAROUSEL_COLOR_ACTIVE });
export var DEFAULT_CAROUSEL_INDICATOR_INACTIVE_STYLE = __assign(__assign({}, DEFAULT_CAROUSEL_INDICATOR_STYLE), { backgroundColor: DEFAULT_CAROUSEL_COLOR_INACTIVE });
