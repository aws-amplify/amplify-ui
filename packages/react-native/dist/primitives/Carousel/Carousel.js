...
export default function Carousel(props) {
    var data = props.data, indicatorActiveStyle = props.indicatorActiveStyle, indicatorInactiveStyle = props.indicatorInactiveStyle, renderItem = props.renderItem, style = props.style;
    ...
    var _b = __read(useState(windowWidthRef.current), 2), width = _b[0], setWidth = _b[1];
    var onViewableItemsChanged = useRef(function (_a) {
        var viewableItems = _a.viewableItems;
        if (viewableItems.length !== 1) {
            return;
        }
        var _b = __read(viewableItems, 1), item = _b[0];
    ...
    useEffect(function () {
        ...
        (_a = flatListRef === null || flatListRef === void 0 ? void 0 : flatListRef.current) === null || _a === void 0 ? void 0 : _a.scrollToOffset({
    ...
    useEffect(function () {
        ...
        var subscription = Dimensions.addEventListener('change', orientationHandler);
    ...
    var carouselRenderItem = function (renderInfo) { return (<View style={{ width: width }}>{renderItem(renderInfo)}</View>); };
