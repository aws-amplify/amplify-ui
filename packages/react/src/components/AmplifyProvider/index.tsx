    ...
    >
      ...
      {/*
          ...
          A: To fix this potential attack vector on the server side, we need to filter out any closing </style> tags, 
             ...
             We also need to catch cases where there is any kind of space character before the closing >, such as tabs, carriage returns, etc:
             </style
        ...
        */}
      {typeof theme === 'undefined' || cssText.includes('</style') ? null : (
        <style
