...
export interface BaseStyleProps extends FlexItemStyleProps, GridItemStyleProps {
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/background-image)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/border)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/bottom)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/color)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/font-style)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/left)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/letter-spacing)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-block)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-block-end)
   */
   ...
   * which maps to a physical margin depending on the element's writing mode, directionality, and text orientation.
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-block-start)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-bottom)
   */
   ...
   * which maps to physical margins depending on the element's writing mode, directionality, and text orientation.
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-inline)
   */
   ...
   * which maps to a physical margin depending on the element's writing mode, directionality, and text orientation.
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-inline-end)
   */
   ...
   * which maps to a physical margin depending on the element's writing mode, directionality, and text orientation.
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-inline-start)
   */
   ...
   * A positive value places it farther from its neighbors, while a negative value places it closer.
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-left)
   */
   ...
   * A positive value places it farther from its neighbors, while a negative value places it closer.
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-right)
   */
   ...
   * A positive value places it farther from its neighbors, while a negative value places it closer.
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/margin-top)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/opacity)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-block)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-block-end)
   */
   ...
   * which maps to a physical padding depending on the element's writing mode, directionality, and text orientation.
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-block-start)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-bottom)
   */
   ...
   * which maps to physical padding properties depending on the element's writing mode, directionality, and text orientation.
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-inline)
   */
   ...
   * which maps to a physical padding depending on the element's writing mode, directionality, and text orientation.
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-inline-end)
   */
   ...
   * which maps to a physical padding depending on the element's writing mode, directionality, and text orientation.
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-inline-start)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-left)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-right)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-top)
   */
   ...
   * @description
   * Participates in specifying the horizontal position of a positioned element. It has no effect on non-positioned elements.
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/right)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/text-transform)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/top)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/transform)
   */
   ...
   * @see [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/transform-origin)
   */
