...
export type StackDirection = "row" | "column" | "column-reverse" | "row-reverse";
...
export type StackAlignContent = "flex-start" | "flex-end" | "stretch" | "center" | "space-between" | "space-around";
