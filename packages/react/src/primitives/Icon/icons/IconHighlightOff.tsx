...
/**
 * @deprecated These icons are being removed in the next major release. You can use the [react-icons](https://react-icons.github.io/react-icons) package or other React icon libraries in its place. `import { IconHighlightOff } from '@aws-amplify/ui-react';` → `import { MdHighlightOff } from 'react-icons/md';`
 */
export const IconHighlightOff = (props) => {
  const { className, ...rest } = props;
  deprecationWarning('IconHighlightOff');
  return (
    <View
      as="span"
      width="1em"
