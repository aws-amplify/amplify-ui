export enum ComponentClassNames {
  ...
  FieldGroupStartIcon = 'amplify-field-group__start-icon',
  FieldGroupEnd = 'amplify-field-group__end',
  FieldGroupEndIcon = 'amplify-field-group__end-icon',
  FieldGroupIcon = 'amplify-field-group__icon',
  FieldGroupIconButton = 'amplify-field-group__icon-button',
  FieldGroupHasEndIcon = 'amplify-field-group--has-end-icon',
  FieldGroupHasStartIcon = 'amplify-field-group--has-start-icon',
