...
import { ForwardRefPrimitive, Primitive, BaseScrollViewProps } from '../types';
import { View } from '../View';

const ScrollViewPrimitive: Primitive<BaseScrollViewProps, 'div'> = (
...
export const ScrollView = React.forwardRef(
  ScrollViewPrimitive
) as ForwardRefPrimitive<BaseScrollViewProps, 'div'>;
