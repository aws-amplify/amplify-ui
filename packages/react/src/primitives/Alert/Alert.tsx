...
import { BaseAlertProps, ForwardRefPrimitive, Primitive } from '../types';
...
const AlertPrimitive: Primitive<BaseAlertProps, 'div'> = (
  {
    buttonRef,
    children,
    className,
 ...
 */
export const Alert = React.forwardRef(AlertPrimitive) as ForwardRefPrimitive<
  BaseAlertProps,
  'div'
>;
