...
describe('SliderField: ', () => {
  ...
  describe('Label', () => {
    it('should render expected field classname', async () => {
      ...
      const label = await screen.findByTestId(SLIDER_LABEL);
    ...
    it('should set id when id is provided', async () => {
      ...
      const label = await screen.findByTestId(SLIDER_LABEL);
      expect(label.id).toBe('slider-field');
    });
  ...
  describe('Slider', () => {
    ...
    describe('Root', () => {
      it('should render default and custom classname', async () => {
        ...
        const root = await screen.findByTestId(SLIDER_ROOT);
    ...
    describe('Track', () => {
      it('should render default classname', async () => {
        render(<SliderField defaultValue={0} label="slider" />);
        const track = await screen.findByTestId(SLIDER_TRACK);
    ...
    describe('Range', () => {
      it('should render default classname', async () => {
        render(<SliderField defaultValue={0} label="slider" />);
        const range = await screen.findByTestId(SLIDER_RANGE);
