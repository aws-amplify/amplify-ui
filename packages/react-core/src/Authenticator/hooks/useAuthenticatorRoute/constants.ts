...
const CONFIRM_VERIFY_USER_KEYS: ConfirmVerifyUserKey[] = ['error', 'isPending'];
const FORCE_PASSWORD_KEYS: ForceNewPasswordKey[] = [
  'error',
  'isPending',
  'toSignIn',
  'validationErrors',
];
const RESET_PASSWORD_KEYS: ResetPasswordKey[] = ['error', 'isPending'];
...
export const MACHINE_KEYS: Record<
  AuthenticatorRouteComponentKey,
  AuthenticatorMachineContextKey[]
> = {
  ...
  forceNewPassword: FORCE_PASSWORD_KEYS,
  signIn: SIGN_IN_KEYS,
  signUp: SIGN_UP_KEYS,
