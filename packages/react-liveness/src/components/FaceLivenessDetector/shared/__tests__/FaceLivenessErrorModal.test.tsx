...
import { FaceLivenessErrorModal, renderErrorModal } from '../FaceLivenessErrorModal';
...
describe('FaceLivenessErrorModal', () => {
  it('should render the component content appropriately', () => {
    ...
    render(<FaceLivenessErrorModal onRetry={() => { }}>
  ...
  it('should render the null error type message appropriately', () => {
    ...
    render(<FaceLivenessErrorModal onRetry={() => { }}>
      {renderErrorModal({ errorState: errorState as unknown as LivenessErrorState })}
    </FaceLivenessErrorModal>);
