/**
 * This file is copied from https://github.com/aws/aws-sdk-js-v3/blob/main/packages/middleware-websocket/src/EventStreamPayloadHandler.ts
 * We had to copy this file so we can override the systemClockOffset in the signer
 */
...
export class EventStreamPayloadHandler implements IEventStreamPayloadHandler {
  ...
  async handle<T extends MetadataBearer>(
    ...
    const priorSignature =
      (match || [])[1] || (query && (query['X-Amz-Signature'] as string)) || '';
