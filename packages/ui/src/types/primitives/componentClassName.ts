export enum ComponentClassName {
  ...
  StorageManagerDropZone = 'amplify-fileuploader__dropzone',
  StorageManagerDropZoneIcon = 'amplify-fileuploader__dropzone__icon',
  StorageManagerDropZoneText = 'amplify-fileuploader__dropzone__text',
  StorageManagerDropZoneButton = 'amplify-fileuploader__dropzone__button',
  StorageManagerFile = 'amplify-fileuploader__file',
  StorageManagerFileWrapper = 'amplify-fileuploader__file__wrapper',
  StorageManagerFileName = 'amplify-fileuploader__file__name',
  StorageManagerFileSize = 'amplify-fileuploader__file__size',
  StorageManagerFileInfo = 'amplify-fileuploader__file__info',
  StorageManagerFileImage = 'amplify-fileuploader__file__image',
  StorageManagerFileMain = 'amplify-fileuploader__file__main',
  StorageManagerFileStatus = 'amplify-fileuploader__file__status',
  StorageManagerLoader = 'amplify-fileuploader__loader',
  StorageManagerPreviewer = 'amplify-fileuploader__previewer',
  StorageManagerPreviewerText = 'amplify-fileuploader__previewer__text',
  StorageManagerPreviewerBody = 'amplify-fileuploader__previewer__body',
  StorageManagerPreviewerFooter = 'amplify-fileuploader__previewer__footer',
  StorageManagerPreviewerFooterActions = 'amplify-fileuploader__previewer__footer__actions',
