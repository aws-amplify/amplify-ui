export const ComponentClassName = {
  ...
  FileUploader: 'amplify-storagemanager',
  FileUploaderDropZone: 'amplify-storagemanager__dropzone',
  FileUploaderDropZoneIcon: 'amplify-storagemanager__dropzone__icon',
  FileUploaderDropZoneText: 'amplify-storagemanager__dropzone__text',
  FileUploaderFilePicker: 'amplify-storagemanager__file__picker',
  FileUploaderFile: 'amplify-storagemanager__file',
  FileUploaderFileWrapper: 'amplify-storagemanager__file__wrapper',
  FileUploaderFileList: 'amplify-storagemanager__file__list',
  FileUploaderFileName: 'amplify-storagemanager__file__name',
  FileUploaderFileSize: 'amplify-storagemanager__file__size',
  FileUploaderFileInfo: 'amplify-storagemanager__file__info',
  FileUploaderFileImage: 'amplify-storagemanager__file__image',
  FileUploaderFileMain: 'amplify-storagemanager__file__main',
  FileUploaderFileStatus: 'amplify-storagemanager__file__status',
  FileUploaderLoader: 'amplify-storagemanager__loader',
  FileUploaderPreviewer: 'amplify-storagemanager__previewer',
  FileUploaderPreviewerText: 'amplify-storagemanager__previewer__text',
  FileUploaderPreviewerActions: 'amplify-storagemanager__previewer__actions',
  FileUploaderPreviewerFooter: 'amplify-storagemanager__previewer__footer',
  Flex: 'amplify-flex',
  Grid: 'amplify-grid',
