export const ComponentClassName = {
  ...
  LoaderTrack: 'amplify-loader__track',
  LoaderRange: 'amplify-loader__range',
  ...
  PaginationItemButton: 'amplify-pagination__item__button',
  PaginationItemCurrent: 'amplify-pagination__item__current',
  PaginationItemEllipsis: 'amplify-pagination__item__ellipsis',
