  ...
  describe('overrides', () => {
    ...
    it('should match snapshot', () => {
      expect(themeWithOverrides.cssText).toMatchInlineSnapshot(`
        ...
        --amplify-components-switchfield-focus-track-shadow: 0px 0px 0px 2px var(--amplify-colors-border-focus);
        --amplify-components-switchfield-checked-thumb-transform: var(--amplify-transforms-slide-x-medium);
        --amplify-components-switchfield-checked-track-background-color: var(--amplify-colors-brand-primary-60);
