  ...
  describe('overrides', () => {
    ...
    it('should match snapshot', () => {
      expect(themeWithOverrides.cssText).toMatchInlineSnapshot(`
        ...
        --amplify-components-table-border-color: var(--amplify-colors-border-tertiary);
        --amplify-components-table-border-style: solid;
        --amplify-components-table-border-width: var(--amplify-border-widths-small);
        --amplify-components-table-padding: var(--amplify-space-medium);
        --amplify-components-table-color: var(--amplify-colors-font-primary);
        --amplify-components-table-font-size-default: var(--amplify-font-sizes-medium);
        --amplify-components-table-font-size-summary: var(--amplify-font-sizes-xs);
        --amplify-components-table-font-weight-td: var(--amplify-font-weights-normal);
        --amplify-components-table-font-weight-th: var(--amplify-font-weights-bold);
        --amplify-components-table-small-font-size: var(--amplify-font-sizes-small);
        --amplify-components-table-small-padding: var(--amplify-space-xs);
        --amplify-components-table-large-font-size-default: var(--amplify-font-sizes-large);
        --amplify-components-table-large-font-size-summary: var(--amplify-font-sizes-small);
        --amplify-components-table-large-padding: var(--amplify-space-large);
