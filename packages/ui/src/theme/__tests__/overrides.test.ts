  ...
  describe('overrides', () => {
    ...
    it('should match snapshot', () => {
      expect(themeWithOverrides.cssText).toMatchInlineSnapshot(`
        ...
        --amplify-components-button-primary-info-disabled-border-color: transparent;
        --amplify-components-button-primary-info-disabled-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-primary-info-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-primary-info-loading-border-color: transparent;
        --amplify-components-button-primary-info-loading-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-primary-info-loading-color: var(--amplify-colors-font-disabled);
        ...
        --amplify-components-button-primary-warning-disabled-border-color: transparent;
        --amplify-components-button-primary-warning-disabled-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-primary-warning-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-primary-warning-loading-border-color: transparent;
        --amplify-components-button-primary-warning-loading-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-primary-warning-loading-color: var(--amplify-colors-font-disabled);
        ...
        --amplify-components-button-primary-error-disabled-border-color: transparent;
        --amplify-components-button-primary-error-disabled-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-primary-error-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-primary-error-loading-border-color: transparent;
        --amplify-components-button-primary-error-loading-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-primary-error-loading-color: var(--amplify-colors-font-disabled);
        ...
        --amplify-components-button-primary-success-disabled-border-color: transparent;
        --amplify-components-button-primary-success-disabled-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-primary-success-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-primary-success-loading-border-color: transparent;
        --amplify-components-button-primary-success-loading-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-primary-success-loading-color: var(--amplify-colors-font-disabled);
        ...
        --amplify-components-button-primary-overlay-disabled-border-color: transparent;
        --amplify-components-button-primary-overlay-disabled-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-primary-overlay-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-primary-overlay-loading-border-color: transparent;
        --amplify-components-button-primary-overlay-loading-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-primary-overlay-loading-color: var(--amplify-colors-font-disabled);
        ...
        --amplify-components-button-link-info-disabled-border-color: transparent;
        --amplify-components-button-link-info-disabled-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-link-info-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-link-info-loading-border-color: transparent;
        --amplify-components-button-link-info-loading-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-link-info-loading-color: var(--amplify-colors-font-disabled);
        ...
        --amplify-components-button-link-warning-disabled-border-color: transparent;
        --amplify-components-button-link-warning-disabled-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-link-warning-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-link-warning-loading-border-color: transparent;
        --amplify-components-button-link-warning-loading-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-link-warning-loading-color: var(--amplify-colors-font-disabled);
        ...
        --amplify-components-button-link-success-disabled-border-color: transparent;
        --amplify-components-button-link-success-disabled-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-link-success-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-link-success-loading-border-color: transparent;
        --amplify-components-button-link-success-loading-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-link-success-loading-color: var(--amplify-colors-font-disabled);
        ...
        --amplify-components-button-link-error-disabled-border-color: transparent;
        --amplify-components-button-link-error-disabled-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-link-error-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-link-error-loading-border-color: transparent;
        --amplify-components-button-link-error-loading-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-link-error-loading-color: var(--amplify-colors-font-disabled);
        ...
        --amplify-components-button-link-overlay-disabled-border-color: transparent;
        --amplify-components-button-link-overlay-disabled-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-link-overlay-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-link-overlay-loading-border-color: transparent;
        --amplify-components-button-link-overlay-loading-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-link-overlay-loading-color: var(--amplify-colors-font-disabled);
        ...
        --amplify-components-button-outlined-background-color: transparent;
        --amplify-components-button-outlined-border-color: var(--amplify-components-fieldcontrol-border-color);
        --amplify-components-button-outlined-border-width: var(--amplify-components-fieldcontrol-border-width);
        --amplify-components-button-outlined-color: var(--amplify-colors-font-primary);
        --amplify-components-button-outlined-hover-border-color: var(--amplify-colors-brand-primary-60);
        --amplify-components-button-outlined-hover-background-color: var(--amplify-colors-brand-primary-10);
        --amplify-components-button-outlined-hover-color: var(--amplify-colors-brand-primary-100);
        --amplify-components-button-outlined-focus-border-color: var(--amplify-colors-brand-primary-100);
        --amplify-components-button-outlined-focus-background-color: var(--amplify-colors-brand-primary-10);
        --amplify-components-button-outlined-focus-color: var(--amplify-colors-brand-primary-100);
        --amplify-components-button-outlined-focus-box-shadow: var(--amplify-components-fieldcontrol-focus-box-shadow);
        --amplify-components-button-outlined-active-border-color: var(--amplify-colors-brand-primary-100);
        --amplify-components-button-outlined-active-background-color: var(--amplify-colors-brand-primary-20);
        --amplify-components-button-outlined-active-color: var(--amplify-colors-brand-primary-100);
        --amplify-components-button-outlined-disabled-border-color: transparent;
        --amplify-components-button-outlined-disabled-background-color: transparent;
        --amplify-components-button-outlined-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-outlined-loading-border-color: transparent;
        --amplify-components-button-outlined-loading-background-color: transparent;
        --amplify-components-button-outlined-loading-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-outlined-info-border-color: var(--amplify-colors-blue-60);
        --amplify-components-button-outlined-info-background-color: transparent;
        --amplify-components-button-outlined-info-color: var(--amplify-colors-blue-100);
        --amplify-components-button-outlined-info-disabled-border-color: transparent;
        --amplify-components-button-outlined-info-disabled-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-outlined-info-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-outlined-info-loading-border-color: transparent;
        --amplify-components-button-outlined-info-loading-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-outlined-info-loading-color: var(--amplify-colors-font-disabled);
        ...
        --amplify-components-button-outlined-warning-disabled-border-color: transparent;
        --amplify-components-button-outlined-warning-disabled-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-outlined-warning-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-outlined-warning-loading-border-color: transparent;
        --amplify-components-button-outlined-warning-loading-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-outlined-warning-loading-color: var(--amplify-colors-font-disabled);
        ...
        --amplify-components-button-outlined-success-disabled-border-color: transparent;
        --amplify-components-button-outlined-success-disabled-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-outlined-success-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-outlined-success-loading-border-color: transparent;
        --amplify-components-button-outlined-success-loading-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-outlined-success-loading-color: var(--amplify-colors-font-disabled);
        ...
        --amplify-components-button-outlined-error-disabled-border-color: transparent;
        --amplify-components-button-outlined-error-disabled-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-outlined-error-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-outlined-error-loading-border-color: transparent;
        --amplify-components-button-outlined-error-loading-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-outlined-error-loading-color: var(--amplify-colors-font-disabled);
        ...
        --amplify-components-button-outlined-overlay-loading-border-color: transparent;
        --amplify-components-button-outlined-overlay-loading-background-color: var(--amplify-colors-background-disabled);
