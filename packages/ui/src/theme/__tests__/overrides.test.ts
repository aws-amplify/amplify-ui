  ...
  describe('overrides', () => {
    ...
    it('should match snapshot', () => {
      expect(themeWithOverrides.cssText).toMatchInlineSnapshot(`
        ...
        --amplify-components-checkbox-button-focus-box-shadow: 0px 0px 0px 2px var(--amplify-colors-focus);
        ...
        --amplify-components-checkbox-button-error-focus-box-shadow: 0px 0px 0px 2px var(--amplify-colors-error);
        ...
        --amplify-components-fieldcontrol-quiet-focus-box-shadow: 0px 1px   var(--amplify-colors-focus);
        --amplify-components-fieldcontrol-quiet-error-border-block-end-color: var(--amplify-colors-error);
        --amplify-components-fieldcontrol-quiet-error-focus-box-shadow: 0px 1px   var(--amplify-colors-error);
        ...
        --amplify-components-togglebutton-primary-pressed-focus-background-color: var(--amplify-colors-focus);
        --amplify-components-togglebutton-primary-pressed-focus-border-color: var(--amplify-colors-focus);
