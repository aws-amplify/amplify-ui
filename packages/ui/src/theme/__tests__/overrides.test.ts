  ...
  describe('overrides', () => {
    ...
    it('should match snapshot', () => {
      expect(themeWithOverrides.cssText).toMatchInlineSnapshot(`
        ...
        --amplify-components-searchfield-menu-width: 100%;
        --amplify-components-searchfield-menu-max-height: 300px;
        --amplify-components-searchfield-menu-margin-top: var(--amplify-space-xxxs);
        --amplify-components-searchfield-menu-background-color: var(--amplify-colors-background-primary);
        --amplify-components-searchfield-menu-border-color: var(--amplify-colors-border-primary);
        --amplify-components-searchfield-menu-border-width: var(--amplify-border-widths-small);
        --amplify-components-searchfield-menu-border-style: solid;
        --amplify-components-searchfield-menu-border-radius: var(--amplify-radii-small);
        --amplify-components-searchfield-menu-suggestions-display: flex;
        --amplify-components-searchfield-menu-suggestions-flex-direction: column;
        --amplify-components-searchfield-menu-suggestion-background-color: var(--amplify-colors-background-primary);
        --amplify-components-searchfield-menu-suggestion-color: currentcolor;
        --amplify-components-searchfield-menu-suggestion-cursor: pointer;
        --amplify-components-searchfield-menu-suggestion-transition-duration: var(--amplify-time-short);
        --amplify-components-searchfield-menu-suggestion-transition-property: background-color, color;
        --amplify-components-searchfield-menu-suggestion-transition-timing-function: ease;
        --amplify-components-searchfield-menu-suggestion-active-background-color: var(--amplify-colors-brand-primary-80);
        --amplify-components-searchfield-menu-suggestion-active-color: var(--amplify-colors-white);
        --amplify-components-searchfield-menu-loading-align-item: center;
        --amplify-components-searchfield-menu-loading-gap: var(--amplify-space-xxxs);
        --amplify-components-searchfield-menu-space-shared-padding-block-end: var(--amplify-space-xs);
        --amplify-components-searchfield-menu-space-shared-padding-block-start: var(--amplify-space-xs);
        --amplify-components-searchfield-menu-space-shared-padding-inline-start: var(--amplify-space-small);
        --amplify-components-searchfield-menu-space-shared-padding-inline-end: var(--amplify-space-small);
