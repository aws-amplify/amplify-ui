  ...
  describe('overrides', () => {
    ...
    it('should match snapshot', () => {
      expect(themeWithOverrides.cssText).toMatchInlineSnapshot(`
        ...
        --amplify-components-accordion-item-focus-box-shadow: 0 0 0 2px var(--amplify-colors-border-focus);
        --amplify-components-accordion-item-trigger-align-items: center;
        --amplify-components-accordion-item-trigger-color: var(--amplify-colors-font-secondary);
        --amplify-components-accordion-item-trigger-background-color: var(--amplify-colors-background-primary);
        --amplify-components-accordion-item-trigger-justify-content: space-between;
        --amplify-components-accordion-item-trigger-padding-block: var(--amplify-space-medium);
        --amplify-components-accordion-item-trigger-padding-inline: var(--amplify-space-medium);
        --amplify-components-accordion-item-trigger-hover-color: var(--amplify-colors-font-secondary);
        --amplify-components-accordion-item-trigger-hover-background-color: var(--amplify-colors-overlay-10);
        --amplify-components-accordion-item-content-color: var(--amplify-colors-font-secondary);
        --amplify-components-accordion-item-content-padding-inline: var(--amplify-space-medium);
        --amplify-components-accordion-item-content-padding-block-end: var(--amplify-space-medium);
        --amplify-components-accordion-item-content-padding-block-start: var(--amplify-space-xs);
