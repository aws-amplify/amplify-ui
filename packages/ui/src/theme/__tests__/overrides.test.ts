  ...
  describe('overrides', () => {
    ...
    it('should match snapshot', () => {
      expect(themeWithOverrides.cssText).toMatchInlineSnapshot(`
        ...
        --amplify-components-expander-box-shadow: 0 1px 10px  var(--amplify-colors-overlay-30);
        --amplify-components-expander-width: 100%;
        --amplify-components-expander-item-margin-top: 1px;
        --amplify-components-expander-item-box-shadow: 0 1px 0  var(--amplify-colors-overlay-20);
        --amplify-components-expander-item-border-start-start-radius: 0.5rem;
        --amplify-components-expander-item-border-start-end-radius: 0.5rem;
        --amplify-components-expander-item-border-end-start-radius: 0.5rem;
        --amplify-components-expander-item-border-end-end-radius: 0.5rem;
        --amplify-components-expander-item-focus-box-shadow: 0 0 0 2px var(--amplify-colors-border-focus);
        --amplify-components-expander-trigger-height: 3rem;
        --amplify-components-expander-trigger-padding-inline-start: 1.5rem;
        --amplify-components-expander-trigger-padding-inline-end: 1.5rem;
        --amplify-components-expander-trigger-align-items: center;
        --amplify-components-expander-trigger-justify-content: space-between;
        --amplify-components-expander-trigger-box-shadow: 0 1px 0  var(--amplify-colors-overlay-20);
        --amplify-components-expander-trigger-hover-background-color: var(--amplify-colors-overlay-10);
        --amplify-components-expander-content-padding-inline-start: 1.5rem;
        --amplify-components-expander-content-padding-inline-end: 1.5rem;
        --amplify-components-expander-content-text-color: var(--amplify-colors-font-secondary);
        --amplify-components-expander-content-text-padding-block-start: 1rem;
        --amplify-components-expander-content-text-padding-block-end: 1rem;
        --amplify-components-expander-content-open-animation-duration: var(--amplify-time-animation-medium);
        --amplify-components-expander-content-closed-animation-duration: var(--amplify-time-animation-medium);
        --amplify-components-expander-icon-transition-duration: var(--amplify-time-transition-medium);
        ...
        --amplify-time-animation-short: 100ms;
        --amplify-time-animation-medium: 250ms;
        --amplify-time-animation-long: 500ms;
