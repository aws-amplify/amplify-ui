  ...
  describe('defaultTheme', () => {
    ...
    it('should match snapshot', () => {
      expect(createTheme().cssText).toMatchInlineSnapshot(`
        ...
        --amplify-components-message-title-font-size: var(--amplify-font-sizes-medium);
        --amplify-components-message-title-font-weight: var(--amplify-font-weights-bold);
        ...
        --amplify-components-message-outline-color: var(--amplify-colors-font-primary);
        --amplify-components-message-outline-background-color: var(--amplify-colors-background-primary);
        --amplify-components-message-outline-border-color: var(--amplify-colors-border-primary);
        --amplify-components-message-outline-info-color: var(--amplify-colors-font-info);
        --amplify-components-message-outline-info-background-color: var(--amplify-colors-background-primary);
        --amplify-components-message-outline-info-border-color: var(--amplify-colors-border-info);
        --amplify-components-message-outline-error-color: var(--amplify-colors-font-error);
        --amplify-components-message-outline-error-background-color: var(--amplify-colors-background-primary);
        --amplify-components-message-outline-error-border-color: var(--amplify-colors-border-error);
        --amplify-components-message-outline-success-color: var(--amplify-colors-font-success);
        --amplify-components-message-outline-success-background-color: var(--amplify-colors-background-primary);
        --amplify-components-message-outline-success-border-color: var(--amplify-colors-border-success);
        --amplify-components-message-outline-warning-color: var(--amplify-colors-font-warning);
        --amplify-components-message-outline-warning-background-color: var(--amplify-colors-background-primary);
        --amplify-components-message-outline-warning-border-color: var(--amplify-colors-border-warning);
