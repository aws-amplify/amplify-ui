  ...
  describe('defaultTheme', () => {
    ...
    it('should match snapshot', () => {
      expect(createTheme().cssText).toMatchInlineSnapshot(`
        ...
        --amplify-components-button-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-button-loading-background-color: var(--amplify-colors-transparent);
        --amplify-components-button-loading-border-color: var(--amplify-colors-border-tertiary);
        --amplify-components-button-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-disabled-background-color: var(--amplify-colors-transparent);
        --amplify-components-button-disabled-border-color: var(--amplify-colors-border-tertiary);
        --amplify-components-button-primary-border-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-button-primary-disabled-border-color: var(--amplify-colors-transparent);
        --amplify-components-button-primary-disabled-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-primary-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-primary-loading-border-color: var(--amplify-colors-transparent);
        --amplify-components-button-primary-loading-background-color: var(--amplify-colors-background-disabled);
        --amplify-components-button-primary-loading-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-primary-hover-border-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-button-primary-focus-border-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-button-primary-active-border-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-button-menu-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-button-menu-disabled-background-color: var(--amplify-colors-transparent);
        --amplify-components-button-menu-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-link-background-color: var(--amplify-colors-transparent);
        --amplify-components-button-link-border-color: var(--amplify-colors-transparent);
        --amplify-components-button-link-border-width: var(--amplify-space-zero);
        --amplify-components-button-link-color: var(--amplify-colors-font-interactive);
        --amplify-components-button-link-hover-border-color: var(--amplify-colors-transparent);
        --amplify-components-button-link-hover-background-color: var(--amplify-colors-brand-primary-10);
        --amplify-components-button-link-hover-color: var(--amplify-colors-font-hover);
        --amplify-components-button-link-focus-border-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-button-link-active-border-color: var(--amplify-colors-transparent);
        --amplify-components-button-link-active-background-color: var(--amplify-colors-brand-primary-20);
        --amplify-components-button-link-active-color: var(--amplify-colors-font-active);
        --amplify-components-button-link-disabled-border-color: var(--amplify-colors-transparent);
        --amplify-components-button-link-disabled-background-color: var(--amplify-colors-transparent);
        --amplify-components-button-link-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-button-link-loading-border-color: var(--amplify-colors-transparent);
        --amplify-components-button-link-loading-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-card-border-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-card-elevated-border-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-checkbox-button-background-color: var(--amplify-components-checkbox-icon-background-color);
        --amplify-components-checkbox-button-color: var(--amplify-colors-font-inverse);
        --amplify-components-checkbox-button-before-width: 100%;
        --amplify-components-checkbox-button-before-height: 100%;
        --amplify-components-checkbox-button-before-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-checkbox-button-focus-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-checkbox-button-disabled-background-color: var(--amplify-colors-transparent);
        --amplify-components-checkbox-button-disabled-border-color: var(--amplify-colors-border-disabled);
        --amplify-components-checkbox-button-error-background-color: var(--amplify-colors-transparent);
        --amplify-components-checkbox-button-error-border-color: var(--amplify-colors-border-error);
        --amplify-components-checkbox-button-error-focus-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-checkbox-label-disabled-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-collection-pagination-button-background-color: var(--amplify-components-pagination-button-background-color);
        --amplify-components-collection-pagination-button-color: var(--amplify-components-pagination-button-color);
        --amplify-components-collection-pagination-button-hover-background-color: var(--amplify-components-pagination-button-hover-background-color);
        --amplify-components-collection-pagination-button-hover-color: var(--amplify-components-pagination-button-hover-color);
        --amplify-components-collection-pagination-button-disabled-background-color: var(--amplify-components-pagination-button-disabled-background-color);
        --amplify-components-collection-pagination-button-disabled-color: var(--amplify-components-pagination-button-disabled-color);
        --amplify-components-collection-search-input-background-color: var(--amplify-components-searchfield-background-color);
        --amplify-components-collection-search-input-color: var(--amplify-components-searchfield-color);
        --amplify-components-collection-search-button-background-color: var(--amplify-components-searchfield-button-background-color);
        ...
        --amplify-components-copy-tool-tip-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-divider-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-expander-content-text-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-field-label-background-color: var(--amplify-colors-transparent);
        --amplify-components-field-label-color: var(--amplify-colors-font-secondary);
        --amplify-components-fieldcontrol-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-fieldcontrol-focus-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-fieldcontrol-error-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-fieldmessages-error-background-color: var(--amplify-colors-transparent);
        --amplify-components-fieldmessages-error-color: var(--amplify-colors-font-error);
        --amplify-components-fieldmessages-error-font-size: var(--amplify-font-sizes-small);
        --amplify-components-fieldmessages-description-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-heading-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-link-active-background-color: var(--amplify-colors-transparent);
        --amplify-components-link-active-color: var(--amplify-colors-font-active);
        --amplify-components-link-background-color: var(--amplify-colors-transparent);
        --amplify-components-link-color: var(--amplify-colors-font-interactive);
        --amplify-components-link-focus-background-color: var(--amplify-colors-transparent);
        --amplify-components-link-focus-color: var(--amplify-colors-font-focus);
        --amplify-components-link-hover-background-color: var(--amplify-colors-transparent);
        --amplify-components-link-hover-color: var(--amplify-colors-font-hover);
        --amplify-components-link-visited-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-pagination-button-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-pagination-button-disabled-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-passwordfield-background-color: var(--amplify-components-fieldcontrol-background-color);
        --amplify-components-passwordfield-color: var(--amplify-components-fieldcontrol-color);
        --amplify-components-passwordfield-button-background-color: var(--amplify-components-button-background-color);
        ...
        --amplify-components-phonenumberfield-background-color: var(--amplify-components-selectfield-background-color);
        --amplify-components-phonenumberfield-border-color: var(--amplify-components-fieldcontrol-border-color);
        --amplify-components-phonenumberfield-font-size: var(--amplify-components-fieldcontrol-font-size);
        --amplify-components-phonenumberfield-focus-background-color: var(--amplify-components-selectfield-focus-background-color);
        ...
        --amplify-components-radio-button-checked-background-color: var(--amplify-colors-transparent);
        --amplify-components-radio-button-checked-color: var(--amplify-colors-brand-primary-80);
        --amplify-components-radio-button-checked-disabled-background-color: var(--amplify-colors-transparent);
        --amplify-components-radio-button-checked-disabled-color: var(--amplify-colors-background-disabled);
        --amplify-components-radio-button-focus-background-color: var(--amplify-colors-transparent);
        --amplify-components-radio-button-focus-border-color: var(--amplify-colors-border-focus);
        --amplify-components-radio-button-focus-box-shadow: var(--amplify-components-fieldcontrol-focus-box-shadow);
        --amplify-components-radio-button-error-background-color: var(--amplify-colors-transparent);
        --amplify-components-radio-button-error-border-color: var(--amplify-colors-border-error);
        --amplify-components-radio-button-error-focus-box-shadow: var(--amplify-components-fieldcontrol-error-focus-box-shadow);
        --amplify-components-radio-button-disabled-border-color: var(--amplify-colors-border-disabled);
        --amplify-components-radio-button-disabled-background-color: var(--amplify-colors-background-primary);
        --amplify-components-radio-label-background-color: var(--amplify-components-text-background-color);
        --amplify-components-radio-label-color: var(--amplify-components-text-color);
        --amplify-components-radio-label-disabled-background-color: var(--amplify-colors-transparent);
        --amplify-components-radio-label-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-radiogroup-radio-border-width: var(--amplify-components-radio-button-border-width);
        --amplify-components-radiogroup-radio-border-color: var(--amplify-components-radio-button-border-color);
        --amplify-components-radiogroup-radio-background-color: var(--amplify-components-radio-button-background-color);
        --amplify-components-radiogroup-radio-checked-background-color: var(--amplify-components-radio-button-checked-background-color);
        --amplify-components-radiogroup-radio-checked-color: var(--amplify-components-radio-button-checked-color);
        --amplify-components-radiogroup-radio-label-background-color: var(--amplify-components-radio-label-background-color);
        --amplify-components-radiogroup-radio-label-color: var(--amplify-components-radio-label-color);
        --amplify-components-radiogroup-label-background-color: var(--amplify-components-field-label-background-color);
        --amplify-components-radiogroup-label-color: var(--amplify-components-field-label-color);
        --amplify-components-rating-large-size: var(--amplify-font-sizes-xxxl);
        --amplify-components-rating-default-size: var(--amplify-font-sizes-xl);
        --amplify-components-rating-small-size: var(--amplify-font-sizes-small);
        --amplify-components-rating-filled-background-color: var(--amplify-colors-transparent);
        --amplify-components-rating-filled-color: var(--amplify-colors-brand-secondary-80);
        --amplify-components-rating-empty-background-color: var(--amplify-colors-transparent);
        --amplify-components-rating-empty-color: var(--amplify-colors-background-tertiary);
        --amplify-components-searchfield-background-color: var(--amplify-components-fieldcontrol-background-color);
        ...
        --amplify-components-select-option-disabled-background-color: var(--amplify-colors-transparent);
        --amplify-components-select-option-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-select-white-space: nowrap;
        --amplify-components-select-min-width: 6.5rem;
        --amplify-components-select-small-min-width: 5.5rem;
        --amplify-components-select-large-min-width: 7.5rem;
        --amplify-components-selectfield-background-color: var(--amplify-components-fieldcontrol-background-color);
        --amplify-components-selectfield-border-color: var(--amplify-components-fieldcontrol-border-color);
        --amplify-components-selectfield-color: var(--amplify-components-fieldcontrol-color);
        --amplify-components-selectfield-flex-direction: column;
        --amplify-components-selectfield-font-size: var(--amplify-components-fieldcontrol-font-size);
        --amplify-components-selectfield-focus-background-color: var(--amplify-components-fieldcontrol-focus-background-color);
        --amplify-components-selectfield-focus-border-color: var(--amplify-components-fieldcontrol-focus-border-color);
        --amplify-components-selectfield-label-background-color: var(--amplify-components-field-label-background-color);
        ...
        --amplify-components-sliderfield-thumb-disabled-border-color: var(--amplify-colors-transparent);
        --amplify-components-sliderfield-thumb-disabled-box-shadow: none;
        --amplify-components-sliderfield-thumb-hover-background-color: var(--amplify-colors-background-primary);
        --amplify-components-sliderfield-thumb-hover-border-color: var(--amplify-colors-border-focus);
        --amplify-components-sliderfield-thumb-focus-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-stepperfield-background-color: var(--amplify-components-button-background-color);
        --amplify-components-stepperfield-border-color: var(--amplify-components-fieldcontrol-border-color);
        --amplify-components-stepperfield-flex-direction: column;
        --amplify-components-stepperfield-input-background-color: var(--amplify-components-fieldcontrol-background-color);
        ...
        --amplify-components-table-header-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-table-data-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-table-caption-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-tabs-background-color: var(--amplify-colors-transparent);
        --amplify-components-tabs-border-color: var(--amplify-colors-border-secondary);
        --amplify-components-tabs-border-style: solid;
        --amplify-components-tabs-border-width: var(--amplify-border-widths-medium);
        --amplify-components-tabs-gap: 0;
        --amplify-components-tabs-item-background-color: var(--amplify-colors-transparent);
        ...
        --amplify-components-tabs-item-hover-background-color: var(--amplify-colors-transparent);
        --amplify-components-tabs-item-hover-color: var(--amplify-colors-font-hover);
        --amplify-components-tabs-item-focus-background-color: var(--amplify-colors-transparent);
        --amplify-components-tabs-item-focus-color: var(--amplify-colors-font-focus);
        --amplify-components-tabs-item-active-color: var(--amplify-colors-font-interactive);
        --amplify-components-tabs-item-active-border-color: var(--amplify-colors-font-interactive);
        --amplify-components-tabs-item-active-background-color: var(--amplify-colors-transparent);
        --amplify-components-tabs-item-disabled-color: var(--amplify-colors-font-disabled);
        --amplify-components-tabs-item-disabled-background-color: var(--amplify-colors-transparent);
        --amplify-components-tabs-item-disabled-border-color: var(--amplify-colors-border-tertiary);
        --amplify-components-text-background-color: var(--amplify-colors-transparent);
        --amplify-components-text-color: var(--amplify-colors-font-primary);
        --amplify-components-text-primary-background-color: var(--amplify-colors-transparent);
        --amplify-components-text-primary-color: var(--amplify-colors-font-primary);
        --amplify-components-text-secondary-background-color: var(--amplify-colors-transparent);
        --amplify-components-text-secondary-color: var(--amplify-colors-font-secondary);
        --amplify-components-text-tertiary-background-color: var(--amplify-colors-transparent);
        --amplify-components-text-tertiary-color: var(--amplify-colors-font-tertiary);
        --amplify-components-text-error-background-color: var(--amplify-colors-transparent);
        --amplify-components-text-error-color: var(--amplify-colors-font-error);
        --amplify-components-text-warning-background-color: var(--amplify-colors-transparent);
        --amplify-components-text-warning-color: var(--amplify-colors-font-warning);
        --amplify-components-text-success-background-color: var(--amplify-colors-transparent);
        --amplify-components-text-success-color: var(--amplify-colors-font-success);
        --amplify-components-text-info-background-color: var(--amplify-colors-transparent);
        --amplify-components-text-info-color: var(--amplify-colors-font-info);
        --amplify-components-textareafield-background-color: var(--amplify-components-fieldcontrol-background-color);
        --amplify-components-textareafield-color: var(--amplify-components-fieldcontrol-color);
        --amplify-components-textareafield-border-color: var(--amplify-components-fieldcontrol-border-color);
        --amplify-components-textareafield-focus-background-color: var(--amplify-components-fieldcontrol-focus-background-color);
        --amplify-components-textareafield-focus-border-color: var(--amplify-components-fieldcontrol-focus-border-color);
        --amplify-components-textfield-background-color: var(--amplify-components-fieldcontrol-background-color);
        --amplify-components-textfield-color: var(--amplify-components-fieldcontrol-color);
        --amplify-components-textfield-border-color: var(--amplify-components-fieldcontrol-border-color);
        --amplify-components-textfield-font-size: var(--amplify-components-fieldcontrol-font-size);
        --amplify-components-textfield-focus-background-color: var(--amplify-components-fieldcontrol-focus-background-color);
        --amplify-components-textfield-focus-border-color: var(--amplify-components-fieldcontrol-focus-border-color);
        --amplify-components-togglebutton-background-color: var(--amplify-colors-transparent);
        --amplify-components-togglebutton-border-color: var(--amplify-colors-border-primary);
        --amplify-components-togglebutton-color: var(--amplify-colors-font-primary);
        --amplify-components-togglebutton-hover-background-color: var(--amplify-colors-overlay-10);
        --amplify-components-togglebutton-focus-background-color: var(--amplify-colors-transparent);
