export const defaultTexts = {
  ...
  LIVENESS_CHECK_FAILED: 'Check unsuccessful. Try again',
  ...
  // Error messages
  LIVENESS_ERROR: 'Check encountered an error. Try again',
  LIVENESS_TIMEOUT: 'Try again. Move face to fit in oval in 5 seconds',
