          ...
          case 0:
            react_1.render(
              jsx_runtime_1.jsx(
                Badge_1.Badge,
                __assign(
                  { variation: 'success', size: 'large' },
                  { children: badgeText }
                ),
                void 0
              )
            );
            return [4 /*yield*/, react_1.screen.findByText(badgeText)];
          case 1:
            badge = _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            expect(
              badge.classList.contains(shared_1.ComponentClassNames.Badge)
            ).toBe(true);
            return [2 /*return*/];
        }
      });
