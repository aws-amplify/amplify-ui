...
var ChatbotComponentCore = /** @class */ (function () {
  ...
  Object.defineProperty(ChatbotComponentCore.prototype, 'data', {
    set: function (data) {
      ...
      this.textEnabled =
        data.textEnabled === undefined ? true : data.textEnabled;
  ...
  ChatbotComponentCore.prototype.doneSpeakingHandler = function () {
    ...
    if (this.lexResponse.contentType === 'audio/mpeg') {
      this.audioControl.play(this.lexResponse.audioStream, function () {
        if (
          _this.lexResponse.dialogState === 'ReadyForFulfillment' ||
          ...
          _this.micButtonDisabled = false;
          _this.audioControl.startRecording(
            _this.onSilenceHandler,
            null,
            _this.voiceConfig.silenceDetectionConfig
          );
          _this.ref.detectChanges();
        }
      });
  ...
  /** @nocollapse */
  ChatbotComponentCore.ctorParameters = function () {
    return [
