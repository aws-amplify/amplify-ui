...
var template =
  ...
  auth.signIn.bodySection +
  '">\n      <div class="amplify-form-header" data-test="' +
  auth.signIn.headerSection +
...
var SignInComponentCore = /** @class */ (function () {
  ...
  /** @nocollapse */
  SignInComponentCore.ctorParameters = function () {
    return [
      {
        type: AmplifyService,
