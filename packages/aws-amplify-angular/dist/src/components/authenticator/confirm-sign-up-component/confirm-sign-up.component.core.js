...
var template =
  ...
  auth.confirmSignUp.section +
  '">\n  <div class="amplify-form-body" data-test="' +
  auth.confirmSignUp.bodySection +
  '">\n    <div\n      class="amplify-form-header"\n      data-test="' +
  auth.confirmSignUp.headerSection +
  ...
  auth.confirmSignUp.usernameInput +
...
var ConfirmSignUpComponentCore = /** @class */ (function () {
  ...
  Object.defineProperty(
    ConfirmSignUpComponentCore.prototype,
    'usernameAttributes',
    {
  ...
  ConfirmSignUpComponentCore.prototype.shouldHide = function (comp) {
    return (
      this.hide.filter(function (item) {
        return item === comp;
      }).length > 0
    );
  };
  ...
  ConfirmSignUpComponentCore.prototype.onConfirm = function () {
    ...
    this.amplifyService
      ...
      .then(function () {
        return _this.logger.info('confirm success');
      })
      .catch(function (err) {
        return _this._setError(err);
      });
  };
  ConfirmSignUpComponentCore.prototype.onResend = function () {
    ...
    this.amplifyService
      ...
      .then(function () {
        return _this.logger.info('code resent');
      })
      .catch(function (err) {
        return _this._setError(err);
      });
  ...
  /** @nocollapse */
  ConfirmSignUpComponentCore.ctorParameters = function () {
    return [
      {
        type: AmplifyService,
        decorators: [{ type: Inject, args: [AmplifyService] }],
      },
    ];
  };
