...
var template =
  ...
  auth.requireNewPassword.newPasswordInput +
  '"\n    />\n    </div>\n    <div class="amplify-form-actions">\n      <div class="amplify-form-cell-left">\n        <a class="amplify-form-link"\n          (click)="onSignIn()"\n          data-test="' +
  auth.requireNewPassword.backToSignInLink +
  '"\n        >{{ this.amplifyService.i18n().get(\'Back to Sign In\') }}</a>\n      </div>\n      <div class="amplify-form-cell-right">\n        <button class="amplify-form-button"\n          (click)="onSubmit()"\n          data-test="' +
  auth.requireNewPassword.submitButton +
...
var RequireNewPasswordComponentCore = /** @class */ (function () {
  ...
  Object.defineProperty(
    RequireNewPasswordComponentCore.prototype,
    'authState',
    {
  ...
  /** @nocollapse */
  RequireNewPasswordComponentCore.ctorParameters = function () {
    return [
      {
        type: AmplifyService,
