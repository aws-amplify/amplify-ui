...
var template =
  ...
  auth.genericAttrs.dialCodeSelect +
  ...
  auth.genericAttrs.phoneNumberInput +
  '"\n            />\n        </div>\n    </div>\n</div>\n';
var PhoneFieldComponentCore = /** @class */ (function () {
  ...
  Object.defineProperty(
    PhoneFieldComponentCore.prototype,
    'defaultCountryCode',
    {
  ...
  PhoneFieldComponentCore.prototype.setLocalPhoneNumber = function (
    local_phone_number
  ) {
  ...
  /** @nocollapse */
  PhoneFieldComponentCore.ctorParameters = function () {
    return [
      {
        type: AmplifyService,
