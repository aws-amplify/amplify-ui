...
var template =
  ...
  auth.signUp.bodySection +
  '">\n      <div\n        class="amplify-form-header"\n        data-test="' +
  auth.signUp.headerSection +
  ...
  auth.signUp.nonPhoneNumberInput +
...
var SignUpComponentCore = /** @class */ (function () {
  ...
  SignUpComponentCore.prototype.onSignUp = function () {
    ...
    var userValues = userKeys.map(function (key) {
  ...
  /** @nocollapse */
  SignUpComponentCore.ctorParameters = function () {
    return [
      {
        type: AmplifyService,
