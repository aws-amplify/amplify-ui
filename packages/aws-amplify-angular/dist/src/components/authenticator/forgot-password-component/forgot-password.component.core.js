...
var template =
  ...
  auth.forgotPassword.newPasswordInput +
  '"\n      />\n      </div>\n      <div class="amplify-form-actions">\n        <div class="amplify-form-cell-right">\n          <button class="amplify-form-button"\n            *ngIf="!code_sent"\n            (click)="onSend()"\n            data-test="' +
  auth.forgotPassword.sendCodeButton +
  ...
  auth.forgotPassword.resendCodeLink +
  '"\n              >\n              {{ this.amplifyService.i18n().get(\'Resend Code\') }}\n            </a>\n            <a\n              *ngIf="!code_sent"\n              class="amplify-form-link"\n              (click)="onSignIn()"\n              data-test="' +
  auth.forgotPassword.backToSignInLink +
...
var ForgotPasswordComponentCore = /** @class */ (function () {
  ...
  Object.defineProperty(
    ForgotPasswordComponentCore.prototype,
    'usernameAttributes',
    {
  ...
  ForgotPasswordComponentCore.prototype.onUsernameFieldChanged = function (
    event
  ) {
  ...
  /** @nocollapse */
  ForgotPasswordComponentCore.ctorParameters = function () {
    return [
      {
        type: AmplifyService,
