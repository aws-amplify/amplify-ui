...
var RenderType_SumerianSceneLoadingComponentIonic = i0.ɵcrt({
  encapsulation: 2,
  styles: styles_SumerianSceneLoadingComponentIonic,
  data: {},
});
export { RenderType_SumerianSceneLoadingComponentIonic as RenderType_SumerianSceneLoadingComponentIonic };
function View_SumerianSceneLoadingComponentIonic_1(_l) {
  return i0.ɵvid(
    0,
    [
      (_l()(),
      i0.ɵeld(
        ...
        1,
        'div',
        [['data-test', 'sumerian-scene-error-text']],
        [[8, 'className', 0]],
        null,
        null,
        null,
    ...
    function (_ck, _v) {
      ...
      var currVal_0 = i0.ɵinlineInterpolate(
        1,
        '',
        _co.AmplifyUI.sceneErrorText,
        ''
      );
      _ck(_v, 0, 0, currVal_0);
      var currVal_1 = _co.sceneError;
      _ck(_v, 1, 0, currVal_1);
    }
  );
}
function View_SumerianSceneLoadingComponentIonic_2(_l) {
  return i0.ɵvid(
    0,
    [
      (_l()(),
      i0.ɵeld(
        ...
        5,
        'div',
        [['data-test', 'sumerian-scene-loading-bar']],
        [[8, 'className', 0]],
        null,
        null,
        null,
    ...
    function (_ck, _v) {
      var _co = _v.component;
      var currVal_2 = _ck(_v, 4, 0, _co.loadPercentage + '%');
...
export function View_SumerianSceneLoadingComponentIonic_0(_l) {
  return i0.ɵvid(
    0,
    [
      (_l()(), i0.ɵted(-1, null, ['\n'])),
      ...
      i0.ɵeld(
        ...
        17,
        'div',
        [['data-test', 'sumerian-scene-loading-logo']],
        [[8, 'className', 0]],
        null,
        null,
        null,
      ...
      i0.ɵeld(
        ...
        1,
        'div',
        [['data-test', 'sumerian-scene-loading-scene-name']],
        [[8, 'className', 0]],
        null,
        null,
        null,
      ...
      i0.ɵand(
        ...
        1,
        null,
        View_SumerianSceneLoadingComponentIonic_1
      )),
      i0.ɵdid(
        28,
        16384,
      ...
      i0.ɵand(
        ...
        1,
        null,
        View_SumerianSceneLoadingComponentIonic_2
      )),
      i0.ɵdid(
        31,
        16384,
    ...
    function (_ck, _v) {
      var _co = _v.component;
      var currVal_5 = _co.sceneError;
      _ck(_v, 28, 0, currVal_5);
      var currVal_6 = !_co.sceneError;
    ...
    function (_ck, _v) {
      ...
      var currVal_1 = i0.ɵinlineInterpolate(
        1,
        '',
        _co.AmplifyUI.loadingContainer,
        ''
      );
      ...
      var currVal_2 = i0.ɵinlineInterpolate(
        1,
        '',
        _co.AmplifyUI.loadingLogo,
        ''
      );
      _ck(_v, 5, 0, currVal_2);
      var currVal_3 = i0.ɵinlineInterpolate(
        1,
        '',
        _co.AmplifyUI.loadingSceneName,
        ''
      );
      _ck(_v, 24, 0, currVal_3);
      var currVal_4 = _co.sceneName;
      _ck(_v, 25, 0, currVal_4);
    }
  );
}
export function View_SumerianSceneLoadingComponentIonic_Host_0(_l) {
  return i0.ɵvid(
    0,
    [
      (_l()(),
      i0.ɵeld(
        ...
        null,
        null,
        View_SumerianSceneLoadingComponentIonic_0,
        RenderType_SumerianSceneLoadingComponentIonic
      )),
      i0.ɵdid(
        1,
        49152,
...
var SumerianSceneLoadingComponentIonicNgFactory = i0.ɵccf(
  'sumerian-scene-loading-ionic',
  i2.SumerianSceneLoadingComponentIonic,
  View_SumerianSceneLoadingComponentIonic_Host_0,
  {
