...
var RenderType_SumerianSceneComponentIonic = i0.ɵcrt({
  encapsulation: 2,
  styles: styles_SumerianSceneComponentIonic,
  data: {},
});
export { RenderType_SumerianSceneComponentIonic as RenderType_SumerianSceneComponentIonic };
function View_SumerianSceneComponentIonic_1(_l) {
  return i0.ɵvid(
    0,
    [
      (_l()(),
      i0.ɵeld(
        ...
        [['data-test', 'sumerian-scene-loading']],
        null,
        null,
        null,
        i1.View_SumerianSceneLoadingComponentIonic_0,
        i1.RenderType_SumerianSceneLoadingComponentIonic
      )),
      i0.ɵdid(
        1,
        49152,
        null,
        0,
        i2.SumerianSceneLoadingComponentIonic,
        [],
        { loadPercentage: [0, 'loadPercentage'], sceneName: [1, 'sceneName'] },
        null
      ),
    ],
    function (_ck, _v) {
      var _co = _v.component;
      var currVal_0 = i0.ɵinlineInterpolate(1, '', _co.loadPercentage, '');
      var currVal_1 = i0.ɵinlineInterpolate(1, '', _co.sceneName, '');
      _ck(_v, 1, 0, currVal_0, currVal_1);
    },
    null
  );
}
function View_SumerianSceneComponentIonic_3(_l) {
  return i0.ɵvid(
    0,
    [
      (_l()(),
...
function View_SumerianSceneComponentIonic_4(_l) {
  return i0.ɵvid(
    0,
    [
      (_l()(),
...
function View_SumerianSceneComponentIonic_5(_l) {
  return i0.ɵvid(
    0,
    [
      (_l()(),
    ...
    function (_ck, _v) {
      var _co = _v.component;
      var currVal_0 = i0.ɵinlineInterpolate(1, '', _co.amplifyUI.tooltip, '');
      _ck(_v, 0, 0, currVal_0);
      var currVal_1 = i0.ɵinlineInterpolate(
        1,
        '',
        _co.amplifyUI.actionButton,
        ''
      );
...
function View_SumerianSceneComponentIonic_6(_l) {
  return i0.ɵvid(
    0,
    [
      (_l()(),
...
function View_SumerianSceneComponentIonic_7(_l) {
  return i0.ɵvid(
    0,
    [
      (_l()(),
...
function View_SumerianSceneComponentIonic_8(_l) {
  return i0.ɵvid(
    0,
    [
      (_l()(),
...
function View_SumerianSceneComponentIonic_2(_l) {
  return i0.ɵvid(
    0,
    [
      (_l()(),
      ...
      i0.ɵeld(
        ...
        27,
        'span',
        [['data-test', 'sumerian-scene-actions']],
        [[8, 'className', 0]],
        null,
        null,
        null,
      ...
      i0.ɵeld(
        ...
        function (_v, en, $event) {
          ...
          if ('click' === en) {
            var pd_0 =
              (_co.muted ? _co.setMuted(false) : _co.setMuted(true)) !== false;
            ad = pd_0 && ad;
          }
          return ad;
        },
      ...
      i0.ɵand(
        ...
        1,
        null,
        View_SumerianSceneComponentIonic_3
      )),
      i0.ɵdid(
        11,
        16384,
      ...
      i0.ɵand(
        ...
        1,
        null,
        View_SumerianSceneComponentIonic_4
      )),
      i0.ɵdid(
        14,
        16384,
      ...
      i0.ɵand(
        ...
        1,
        null,
        View_SumerianSceneComponentIonic_5
      )),
      i0.ɵdid(
        19,
        16384,
      ...
      i0.ɵand(
        ...
        1,
        null,
        View_SumerianSceneComponentIonic_6
      )),
      i0.ɵdid(
        22,
        16384,
      ...
      i0.ɵand(
        ...
        1,
        null,
        View_SumerianSceneComponentIonic_7
      )),
      i0.ɵdid(
        25,
        16384,
      ...
      i0.ɵand(
        ...
        1,
        null,
        View_SumerianSceneComponentIonic_8
      )),
      i0.ɵdid(
        28,
        16384,
    ...
    function (_ck, _v) {
      ...
      var currVal_3 = _ck(
        ...
        6,
        0,
        _co.amplifyUI.tooltip,
        _co.showEnableAudio ? _co.amplifyUI.autoShowTooltip : ''
      );
      _ck(_v, 5, 0, currVal_3);
      var currVal_5 = _co.muted;
      _ck(_v, 11, 0, currVal_5);
      var currVal_6 = !_co.muted;
      _ck(_v, 14, 0, currVal_6);
      var currVal_7 = _co.isVRCapable && !_co.isVRPresentationActive;
      _ck(_v, 19, 0, currVal_7);
      var currVal_8 = _co.isVRCapable && _co.isVRPresentationActive;
      _ck(_v, 22, 0, currVal_8);
      var currVal_9 = !_co.isFullscreen;
      _ck(_v, 25, 0, currVal_9);
      var currVal_10 = _co.isFullscreen;
      _ck(_v, 28, 0, currVal_10);
    },
    function (_ck, _v) {
      var _co = _v.component;
      var currVal_0 = i0.ɵinlineInterpolate(1, '', _co.amplifyUI.sceneBar, '');
      _ck(_v, 0, 0, currVal_0);
      var currVal_1 = i0.ɵinlineInterpolate(
        1,
        '',
        _co.amplifyUI.sceneActions,
        ''
      );
      _ck(_v, 2, 0, currVal_1);
      var currVal_2 = _co.showEnableAudio
        ? 'The scene is muted. Click to unmute.'
        : _co.muted
        ? 'Unmute'
        : 'Mute';
      _ck(_v, 4, 0, currVal_2);
      var currVal_4 = i0.ɵinlineInterpolate(
        1,
        '',
        _co.amplifyUI.actionButton,
        ''
...
export function View_SumerianSceneComponentIonic_0(_l) {
  return i0.ɵvid(
    0,
    [
      (_l()(), i0.ɵted(-1, null, ['\n'])),
      ...
      i0.ɵeld(
        ...
        'div',
        [
          ['data-test', 'sumerian-scene-container'],
          ['id', 'sumerian-scene-container'],
        ],
        null,
        null,
        null,
      ...
      i0.ɵand(
        ...
        1,
        null,
        View_SumerianSceneComponentIonic_1
      )),
      i0.ɵdid(
        7,
        16384,
      ...
      i0.ɵand(
        ...
        1,
        null,
        View_SumerianSceneComponentIonic_2
      )),
      i0.ɵdid(
        11,
        16384,
    ...
    function (_ck, _v) {
      var _co = _v.component;
      var currVal_0 = _co.amplifyUI.sumerianSceneContainer;
    ...
    function (_ck, _v) {
      var _co = _v.component;
      var currVal_1 = _co.amplifyUI.sumerianScene;
      _ck(_v, 4, 0, currVal_1);
    }
  );
}
export function View_SumerianSceneComponentIonic_Host_0(_l) {
  return i0.ɵvid(
    0,
    [
      (_l()(),
      i0.ɵeld(
        ...
        null,
        1,
        'sumerian-scene-ionic',
        [],
        null,
        null,
        null,
        View_SumerianSceneComponentIonic_0,
        RenderType_SumerianSceneComponentIonic
      )),
      i0.ɵdid(
        1,
        245760,
        null,
        0,
        i4.SumerianSceneComponentIonic,
        [i5.AmplifyService],
        null,
        null
      ),
...
var SumerianSceneComponentIonicNgFactory = i0.ɵccf(
  'sumerian-scene-ionic',
  i4.SumerianSceneComponentIonic,
  View_SumerianSceneComponentIonic_Host_0,
  { sceneName: 'sceneName', data: 'data' },
  {},
  []
);
