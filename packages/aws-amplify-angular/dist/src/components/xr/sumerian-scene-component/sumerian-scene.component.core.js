...
var template =
  ...
  sumerianScene.bar +
  '">\n    <span class={{amplifyUI.sceneActions}} data-test="' +
  sumerianScene.actions +
...
var SumerianSceneComponentCore = /** @class */ (function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 4:
            ...
            this.isVRCapable = this.amplifyService
              .xr()
              .isVRCapable(this.sceneName);
            this.isVRPresentationActive = this.amplifyService
              .xr()
              .isVRPresentationActive(this.sceneName);
            this.amplifyService
              .xr()
              .onSceneEvent(this.sceneName, 'AudioEnabled', function () {
                return (_this.showEnableAudio = false);
              });
            this.amplifyService
              .xr()
              .onSceneEvent(this.sceneName, 'AudioDisabled', function () {
  ...
  /** @nocollapse */
  SumerianSceneComponentCore.ctorParameters = function () {
    return [{ type: AmplifyService }];
  };
