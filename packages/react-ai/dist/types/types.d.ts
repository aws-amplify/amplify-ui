import { Conversation as SDKConversation, ConversationMessage as SDKConversationMessage, ConversationRoute as SDKConversationRoute } from '@aws-amplify/data-schema/dist/esm/ai/ConversationType';
...
export interface SendMesageParameters {
    ...
    responseComponents?: Parameters<Conversation['sendMessage']>[0]['toolConfiguration'];
}
