...
const getIconProps = ({ variant, ...props }) => {
    ...
    const children = pathData ? (React.createElement("path", { d: pathData, fill: "currentColor" })) : undefined;
    return {
...
const IconElement = withBaseElementProps(BaseIconElement, getIconProps);

export { BaseIconElement, DEFAULT_ICON_PATHS, IconElement };
