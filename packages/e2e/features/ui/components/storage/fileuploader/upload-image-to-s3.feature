...
Testing upload image feature
  ...
  Scenario: I select a file and  upload it
    ...
    Given I intercept '{ "method": "PUT", "url": "**/test.jpg?partNumber**"  }' with fixture "FileUploader-upload-part.xml" and add header "Etag" with value "&quot;abc123&quot;"
    Given I intercept '{ "method": "POST", "url": "**/test.jpg?uploadId**"  }' with fixture "FileUploader-upload-multipart-complete.xml"
