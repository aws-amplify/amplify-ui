Feature: FileUploader with default files

  Background:
    Given I'm running the example "ui/components/storage/file-uploader/default-files"

  @react
  Scenario: FileUploader renders with default files
