Feature: Sign Up with Attributes
  ...
  Background:
    Given I'm running the example "ui/components/authenticator/gen2/sign-up-with-attributes"
  ...
  @angular @react @vue @react-native
  # "name" attribute is missing from the gen2 config due to a bug 
  # TODO: https://app.asana.com/0/1202482785776886/1207309171982876
