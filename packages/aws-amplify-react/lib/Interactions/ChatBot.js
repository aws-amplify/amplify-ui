...
var ChatBot = /** @class */ (function (_super) {
        ...
        switch (_a.label) {
          case 0:
            if (
              ...
              typeof interactions_1.Interactions.send !== 'function'
            ) {
              throw new Error(
  ...
  ChatBot.prototype.componentDidMount = function () {
    ...
    if (onComplete && botName) {
      if (
        !interactions_1.Interactions ||
        typeof interactions_1.Interactions.onComplete !== 'function'
      ) {
        throw new Error(
          'No Interactions module found, please ensure @aws-amplify/interactions is imported'
        );
    ...
    return React.createElement(
      ...
      title &&
        React.createElement(
          ...
          { theme: theme, 'data-test': data_test_attributes_1.chatBot.title },
