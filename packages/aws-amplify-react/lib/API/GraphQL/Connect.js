      ...
      return __generator(this, function (_k) {
        switch (_k.label) {
          case 0:
            ...
            hasValidQuery =
              query && api_1.API.getGraphqlOperationType(query) === 'query';
            hasValidMutation =
              mutation &&
              api_1.API.getGraphqlOperationType(mutation) === 'mutation';
            hasValidSubscription =
              subscription &&
              api_1.API.getGraphqlOperationType(subscription.query) ===
                'subscription';
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              api_1.API.graphql({ query: query, variables: variables }),
            ];
          case 2:
            response = _k.sent();
            // @ts-ignore
