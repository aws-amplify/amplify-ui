        ...
        !(function (undefined) {
          ...
          !(function (t) {
              ...
              (s || f) &&
                (c = function (t) {
                  ...
                  return (
                    ...
                    s &&
                      e &&
                      (c.lastIndex = c.global ? e.index + e[0].length : r),
                    f &&
                      e &&
                      e.length > 1 &&
              ...
              t.exports =
                ...
                ('__proto__' in {}
                  ? (function () {
                      ...
                      return function (n, i) {
                        return (
                          e(n), o(i), r ? t.call(n, i) : (n.__proto__ = i), n
                        );
                      };
                    })()
                  : void 0);
            ...
            function (t, r, n) {
              var e = n(185);
              t.exports =
                /Version\/10\.\d+(\.\d+)?( Mobile\/\w+)? Safari\//.test(e);
            },
            function (t, r, n) {
              var e = n(52),
                o = n(23).getWeakData,
                    ...
                    [
                      ...
                      function (t, o) {
                        ...
                        for (var b = 0, S = 0, w = []; S < h.length; ) {
                          ...
                          if (
                            null === O ||
                            (E = v(s(x.lastIndex + (g ? 0 : S)), h.length)) ===
                              b
                          )
                            S = c(h, S, d);
                          else {
            ...
            function (t, r, n) {
              ...
              d(wt, 'URL'),
                o({ global: !0, forced: !u, sham: !i }, { URL: wt });
            },
            function (t, r, n) {
              var e = /[^\0-\u007E]/,
                o = /[.\u3002\uFF0E\uFF61]/g,
          ...
          (function (t) {
            'use strict';
            var e_searchParams = 'URLSearchParams' in self,
              e_iterable = 'Symbol' in self && 'iterator' in Symbol,
              e_blob =
                'FileReader' in self &&
                'Blob' in self &&
                (function () {
              ...
              e_formData = 'FormData' in self,
              e_arrayBuffer = 'ArrayBuffer' in self;
            if (e_arrayBuffer)
              var r = [
                  '[object Int8Array]',
                  '[object Uint8Array]',
                ...
                (this._initBody = function (t) {
                  ...
                  (this._bodyInit = t),
                    t
                      ? 'string' == typeof t
                        ? (this._bodyText = t)
                        : e_blob && Blob.prototype.isPrototypeOf(t)
                        ? (this._bodyBlob = t)
                        : e_formData && FormData.prototype.isPrototypeOf(t)
            ...
            function w(r, o) {
              return new Promise(function (n, i) {
                ...
                (h.onload = function () {
                  ...
                  'responseType' in h && e_blob && (h.responseType = 'blob'),
...
//# sourceMappingURL=vendors~polyfills-core-js.43062421b39d2bb010e4.bundle.js.map
