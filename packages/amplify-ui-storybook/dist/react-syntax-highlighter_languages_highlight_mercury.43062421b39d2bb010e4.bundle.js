    ...
    1887: function (module, exports) {
      module.exports = function (hljs) {
        var COMMENT = hljs.COMMENT('%', '$'),
          ATOM = hljs.inherit(hljs.APOS_STRING_MODE, { relevance: 0 }),
          STRING = hljs.inherit(hljs.QUOTE_STRING_MODE, { relevance: 0 });
        (STRING.contains = STRING.contains.slice()),
          STRING.contains.push({
            className: 'subst',
            begin:
...
//# sourceMappingURL=react-syntax-highlighter_languages_highlight_mercury.43062421b39d2bb010e4.bundle.js.map
