    ...
    1854: function (module, exports) {
      module.exports = function (hljs) {
        var COMMENT = {
          ...
          PRAGMA = { className: 'meta', begin: '{-#', end: '#-}' },
          PREPROCESSOR = { className: 'meta', begin: '^#', end: '$' },
          CONSTRUCTOR = {
            className: 'type',
            begin: "\\b[A-Z][\\w']*",
            relevance: 0,
          ...
          contains: [
            ...
            },
            {
              ...
              contains: [
                ...
                CONSTRUCTOR,
                LIST,
                { begin: '{', end: '}', contains: LIST.contains },
                COMMENT,
              ],
            },
            {
...
//# sourceMappingURL=react-syntax-highlighter_languages_highlight_haskell.43062421b39d2bb010e4.bundle.js.map
