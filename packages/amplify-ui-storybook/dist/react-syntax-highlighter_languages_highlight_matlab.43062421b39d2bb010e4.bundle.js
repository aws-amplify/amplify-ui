  ...
  [101],
  {
    1884: function (module, exports) {
      module.exports = function (hljs) {
        var TRANSPOSE = { relevance: 0, contains: [{ begin: "('|\\.')+" }] };
        return {
          keywords: {
            keyword:
          ...
          contains: [
            ...
            { begin: /\]|}|\)/, relevance: 0, starts: TRANSPOSE },
            {
              className: 'string',
              begin: '"',
              end: '"',
...
//# sourceMappingURL=react-syntax-highlighter_languages_highlight_matlab.43062421b39d2bb010e4.bundle.js.map
