    ...
    1901: function (module, exports) {
      module.exports = function (hljs) {
        var OXYGENE_KEYWORDS =
          ...
          CURLY_COMMENT = hljs.COMMENT('{', '}', { relevance: 0 }),
          PAREN_COMMENT = hljs.COMMENT('\\(\\*', '\\*\\)', { relevance: 10 }),
          STRING = {
            className: 'string',
            begin: "'",
            end: "'",
          ...
          CHAR_STRING = { className: 'string', begin: '(#\\d+)+' },
          FUNCTION = {
            className: 'function',
...
//# sourceMappingURL=react-syntax-highlighter_languages_highlight_oxygene.43062421b39d2bb010e4.bundle.js.map
