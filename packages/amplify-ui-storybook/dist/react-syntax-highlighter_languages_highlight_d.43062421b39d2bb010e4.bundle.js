      ...
      module.exports = function (hljs) {
        var integer_re =
          ...
          D_STRING_MODE = {
            className: 'string',
            begin: '"',
            contains: [{ begin: escape_sequence_re, relevance: 0 }],
            end: '"[cwd]?',
          },
          D_NESTING_COMMENT_MODE = hljs.COMMENT('\\/\\+', '\\+\\/', {
            contains: ['self'],
            relevance: 10,
          });
        return {
...
//# sourceMappingURL=react-syntax-highlighter_languages_highlight_d.43062421b39d2bb010e4.bundle.js.map
