    ...
    1909: function (module, exports) {
      module.exports = function (hljs) {
        var KEYWORDS = {
          ...
          BACKTICK_ESCAPE = { begin: '`[\\s\\S]', relevance: 0 },
          VAR = {
            className: 'variable',
            variants: [
              { begin: /\$\B/ },
          ...
          PS_COMMENT = hljs.inherit(hljs.COMMENT(null, null), {
            variants: [
              { begin: /#/, end: /$/ },
              { begin: /<#/, end: /#>/ },
            ],
          ...
          PS_METHODS = {
            ...
            contains: [
              ...
              hljs.inherit(hljs.TITLE_MODE, { endsParent: !0 }),
            ],
          },
          GENTLEMANS_SET = [
            PS_METHODS,
...
//# sourceMappingURL=react-syntax-highlighter_languages_highlight_powershell.43062421b39d2bb010e4.bundle.js.map
