  ...
  [113],
  {
    1897: function (module, exports) {
      module.exports = function (hljs) {
        var DEFINES = { className: 'variable', begin: /\$+{[\w\.:-]+}/ },
          VARIABLES = {
            className: 'variable',
            begin: /\$+\w+/,
            illegal: /\(\){}/,
          },
          LANGUAGES = { className: 'variable', begin: /\$+\([\w\^\.:-]+\)/ },
          STRING = {
            className: 'string',
            variants: [
              { begin: '"', end: '"' },
...
//# sourceMappingURL=react-syntax-highlighter_languages_highlight_nsis.43062421b39d2bb010e4.bundle.js.map
