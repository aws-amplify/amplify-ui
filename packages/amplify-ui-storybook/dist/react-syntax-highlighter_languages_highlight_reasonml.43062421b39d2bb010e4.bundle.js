    ...
    1921: function (module, exports) {
      module.exports = function (hljs) {
        var RE_IDENT = '~?[a-z$_][0-9a-zA-Z$_]*',
          RE_MODULE_IDENT = '`?[A-Z$_][0-9a-zA-Z$_]*',
          RE_OPERATOR =
            '(' +
            ...
            '|==|===)',
          RE_OPERATOR_SPACED = '\\s+' + RE_OPERATOR + '\\s+',
          KEYWORDS = {
            keyword:
          ...
          LIST_CONTENTS_MODES = [
            { className: 'identifier', relevance: 0, begin: RE_IDENT },
            OPERATOR_MODE,
            NUMBER_MODE,
          ],
        ...
        var CONSTRUCTOR_MODE = {
            ...
            contains: [
              hljs.QUOTE_STRING_MODE,
              OPERATOR_MODE,
              { className: 'params', begin: '\\b' + RE_IDENT },
            ],
          },
          ...
          PARAMS_CONTENTS.push(MODULE_ACCESS_MODE),
          {
            ...
            contains: [
              ...
              FUNCTION_BLOCK_MODE,
              {
                ...
                relevance: 0,
                contains: [
                  { className: 'module', relevance: 0, begin: RE_MODULE_IDENT },
                  { begin: '{', end: '}', skip: !0 },
                ].concat(MODULE_ACCESS_CONTENTS),
              },
              MODULE_ACCESS_MODE,
...
//# sourceMappingURL=react-syntax-highlighter_languages_highlight_reasonml.43062421b39d2bb010e4.bundle.js.map
